// app/states/alaska/page.tsx
import type { Metadata } from 'next';
import Link from 'next/link';

const STATE = 'Alaska';
const DEADLINE = '14 / 30 days';
const STATUTE = 'AS § 34.03.070';
const PENALTY = 'up to 2× for willful withholding';
    ...
    <div className="min-h-screen bg-[#FAFAF7]" style={{ fontFamily: 'var(--font-sans)' }}>
      ...
      <section className="mx-auto max-w-4xl px-5 py-16 sm:px-8 sm:py-24">
        ...
        <p className="mt-6 max-w-2xl text-lg text-slate-700">
          A professional demand letter citing Alaska's Uniform Residential Landlord and Tenant Act (AS &sect; 34.03.070), the return deadlines, and the double-damages penalty for willful withholding. Ready in minutes.
        </p>
      ...
      <section className="mx-auto max-w-4xl px-5 pb-16 sm:px-8">
        <div className="grid gap-4 sm:grid-cols-3">
          <div className="rounded-xl border border-[#E7E5E0] bg-white p-6">
            ...
            <p className="mt-1 text-sm text-slate-600">14 with proper notice, 30 otherwise</p>
          </div>
          <div className="rounded-xl border border-[#E7E5E0] bg-white p-6">
            <p className="text-xs font-semibold uppercase tracking-widest text-slate-500">Penalty</p>
            <p className="mt-2 text-2xl font-medium text-slate-900" style={{ fontFamily: 'var(--font-display)' }}>2&times; willful</p>
            <p className="mt-1 text-sm text-slate-600">for willful noncompliance under &sect; 34.03.070</p>
          </div>
          <div className="rounded-xl border border-[#E7E5E0] bg-white p-6">
            <p className="text-xs font-semibold uppercase tracking-widest text-slate-500">Statute</p>
            <p className="mt-2 text-2xl font-medium text-slate-900" style={{ fontFamily: 'var(--font-display)' }}>§ 34.03.070</p>
            <p className="mt-1 text-sm text-slate-600">Alaska Statutes</p>
          </div>
        </div>
      </section>
      ...
      <section className="mx-auto max-w-3xl px-5 py-16 sm:px-8 sm:py-20">
        ...
        <div className="mt-8 space-y-6 text-slate-700">
          <p>
            Under <strong>AS &sect; 34.03.070</strong>, your landlord must return your deposit within <strong>14 days</strong> if you gave proper termination notice, or within <strong>30 days</strong> if you did not give notice or the landlord is deducting for damages &mdash; along with a written, itemized statement.
          </p>
          <p>
            If the landlord&apos;s noncompliance is <strong>willful</strong>, you may recover:
          </p>
          <ul className="ml-6 list-disc space-y-2">
            <li><strong>Up to twice</strong> the amount wrongfully withheld</li>
          </ul>
          <p>
        ...
        <div className="mx-auto max-w-4xl px-5 py-16 sm:px-8 sm:py-20">
          ...
          <div className="mt-8 grid gap-6 sm:grid-cols-2">
            ...
            <div>
              ...
              <p className="mt-2 text-sm text-slate-600">AS &sect; 34.03.070 and any others triggered by your circumstances &mdash; not generic legalese.</p>
            </div>
            <div>
              <h3 className="font-medium text-slate-900">Calculated penalty math</h3>
              <p className="mt-2 text-sm text-slate-600">The letter states the exact dollar amount you&apos;re entitled to demand &mdash; up to 2&times; the wrongfully withheld amount where withholding is willful.</p>
            </div>
            <div>
