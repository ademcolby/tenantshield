...
const STATUTE = '68 P.S. § 250.512';
const PENALTY = '2× the amount wrongfully withheld';

export const metadata: Metadata = {
  title: 'Security Deposit Demand Letter Pennsylvania | TenantShield',
    ...
    <div className="min-h-screen bg-[#FAFAF7]" style={{ fontFamily: 'var(--font-sans)' }}>
      ...
      <section className="mx-auto max-w-4xl px-5 py-16 sm:px-8 sm:py-24">
        ...
        <p className="mt-6 max-w-2xl text-lg text-slate-700">
          A professional demand letter citing {STATE}&apos;s Landlord and Tenant Act (68 P.S. &sect; 250.512), the 30-day return deadline, and the double-damages penalty for wrongful withholding. Ready in minutes.
        </p>
      ...
      <section className="mx-auto max-w-4xl px-5 pb-16 sm:px-8">
        <div className="grid gap-4 sm:grid-cols-3">
          ...
          <div className="rounded-xl border border-[#E7E5E0] bg-white p-6">
            ...
            <p className="mt-1 text-sm text-slate-600">for wrongful withholding under {STATUTE}</p>
          </div>
          <div className="rounded-xl border border-[#E7E5E0] bg-white p-6">
            <p className="text-xs font-semibold uppercase tracking-widest text-slate-500">Statute</p>
            <p className="mt-2 text-2xl font-medium text-slate-900" style={{ fontFamily: 'var(--font-display)' }}>&sect; 250.512</p>
            <p className="mt-1 text-sm text-slate-600">{STATE} Statutes (Title 68)</p>
          </div>
        </div>
      </section>
      ...
      <section className="mx-auto max-w-3xl px-5 py-16 sm:px-8 sm:py-20">
        ...
        <div className="mt-8 space-y-6 text-slate-700">
          <p>
            Under <strong>{STATUTE}</strong>, your landlord has <strong>30 days</strong> after your tenancy ends to return your security deposit or provide a written, itemized list of any deductions for damages.
          </p>
          <p>
            If the landlord fails to provide that written list and refund within 30 days, the landlord loses the right to keep any of the deposit and becomes liable for <strong>double</strong> the amount wrongfully withheld:
          </p>
          <ul className="ml-6 list-disc space-y-2">
            <li><strong>Two times</strong> the amount by which the deposit exceeds the landlord&apos;s actual, properly documented damages</li>
          </ul>
          <p>
          ...
          <p className="rounded-lg border border-[#E7E5E0] bg-white p-5 text-sm text-slate-600">
            <strong className="text-slate-900">Good to know:</strong> {STATE} caps deposits at <strong>two months&apos; rent</strong> in the first year and <strong>one month&apos;s rent</strong> thereafter. To preserve the double-damages right, you must give the landlord a written forwarding address &mdash; which your letter provides.
          </p>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-4xl px-5 py-16 sm:px-8 sm:py-20">
          ...
          <div className="mt-8 grid gap-6 sm:grid-cols-2">
            ...
            <div>
              ...
              <p className="mt-2 text-sm text-slate-600">68 P.S. &sect; 250.512 and any others triggered by your circumstances &mdash; not generic legalese.</p>
            </div>
            <div>
              <h3 className="font-medium text-slate-900">Calculated penalty math</h3>
              <p className="mt-2 text-sm text-slate-600">The letter states the exact dollar amount you&apos;re entitled to demand &mdash; double the amount wrongfully withheld &mdash; and supplies your forwarding address in writing.</p>
            </div>
            <div>
