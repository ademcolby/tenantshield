// app/states/vermont/page.tsx
import type { Metadata } from 'next';
import Link from 'next/link';

const STATE = 'Vermont';
const DEADLINE = '14 days';
const STATUTE = '9 V.S.A. § 4461';
const PENALTY = '2× for willful withholding + attorney fees';
    ...
    <div className="min-h-screen bg-[#FAFAF7]" style={{ fontFamily: 'var(--font-sans)' }}>
      ...
      <section className="mx-auto max-w-4xl px-5 py-16 sm:px-8 sm:py-24">
        ...
        <p className="mt-6 max-w-2xl text-lg text-slate-700">
          A professional demand letter citing Vermont's security deposit statute (9 V.S.A. &sect; 4461), the 14-day return deadline, and the double-damages penalty for willful withholding. Ready in minutes.
        </p>
      ...
      <section className="mx-auto max-w-4xl px-5 pb-16 sm:px-8">
        <div className="grid gap-4 sm:grid-cols-3">
          ...
          <div className="rounded-xl border border-[#E7E5E0] bg-white p-6">
            ...
            <p className="mt-1 text-sm text-slate-600">for willful withholding under &sect; 4461</p>
          </div>
          <div className="rounded-xl border border-[#E7E5E0] bg-white p-6">
            <p className="text-xs font-semibold uppercase tracking-widest text-slate-500">Statute</p>
            <p className="mt-2 text-2xl font-medium text-slate-900" style={{ fontFamily: 'var(--font-display)' }}>§ 4461</p>
            <p className="mt-1 text-sm text-slate-600">Vermont Statutes Annotated</p>
          </div>
        </div>
      </section>
      ...
      <section className="mx-auto max-w-3xl px-5 py-16 sm:px-8 sm:py-20">
        ...
        <div className="mt-8 space-y-6 text-slate-700">
          <p>
            Under <strong>9 V.S.A. &sect; 4461</strong>, your landlord has <strong>14 days</strong> after your tenancy ends to return your security deposit along with a written, itemized statement of any deductions. Missing that deadline forfeits the right to withhold.
          </p>
          <p>
            If the landlord <strong>willfully</strong> fails to comply, you may recover:
          </p>
        ...
        <div className="mx-auto max-w-4xl px-5 py-16 sm:px-8 sm:py-20">
          ...
          <div className="mt-8 grid gap-6 sm:grid-cols-2">
            ...
            <div>
              ...
              <p className="mt-2 text-sm text-slate-600">9 V.S.A. &sect; 4461 and any others triggered by your circumstances &mdash; not generic legalese.</p>
            </div>
            <div>
              <h3 className="font-medium text-slate-900">Calculated penalty math</h3>
              <p className="mt-2 text-sm text-slate-600">The letter states the exact dollar amount you&apos;re entitled to demand &mdash; deposit + 2&times; wrongful withholding + fees where conduct is willful.</p>
            </div>
            <div>
