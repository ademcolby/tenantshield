// app/states/south-dakota/page.tsx
import type { Metadata } from 'next';
import Link from 'next/link';

const STATE = 'South Dakota';
const DEADLINE = '14 / 45 days';
const STATUTE = 'SDCL § 43-32-24';
const PENALTY = 'forfeiture + up to $200 punitive damages';
    ...
    <div className="min-h-screen bg-[#FAFAF7]" style={{ fontFamily: 'var(--font-sans)' }}>
      ...
      <section className="mx-auto max-w-4xl px-5 py-16 sm:px-8 sm:py-24">
        ...
        <p className="mt-6 max-w-2xl text-lg text-slate-700">
          A professional demand letter citing South Dakota's security deposit statute (SDCL &sect; 43-32-24), the return deadlines, and the forfeiture-plus-penalty remedy. Ready in minutes.
        </p>
      ...
      <section className="mx-auto max-w-4xl px-5 pb-16 sm:px-8">
        <div className="grid gap-4 sm:grid-cols-3">
          <div className="rounded-xl border border-[#E7E5E0] bg-white p-6">
            ...
            <p className="mt-1 text-sm text-slate-600">14 to return, 45 for an itemized accounting on request</p>
          </div>
          <div className="rounded-xl border border-[#E7E5E0] bg-white p-6">
            <p className="text-xs font-semibold uppercase tracking-widest text-slate-500">Penalty</p>
            <p className="mt-2 text-2xl font-medium text-slate-900" style={{ fontFamily: 'var(--font-display)' }}>$200 + forfeiture</p>
            <p className="mt-1 text-sm text-slate-600">for bad-faith withholding under &sect; 43-32-24</p>
          </div>
          <div className="rounded-xl border border-[#E7E5E0] bg-white p-6">
            <p className="text-xs font-semibold uppercase tracking-widest text-slate-500">Statute</p>
            <p className="mt-2 text-2xl font-medium text-slate-900" style={{ fontFamily: 'var(--font-display)' }}>§ 43-32-24</p>
            <p className="mt-1 text-sm text-slate-600">South Dakota Codified Laws</p>
          </div>
        </div>
      </section>
      ...
      <section className="mx-auto max-w-3xl px-5 py-16 sm:px-8 sm:py-20">
        ...
        <div className="mt-8 space-y-6 text-slate-700">
          <p>
            Under <strong>SDCL &sect; 43-32-24</strong>, your landlord must return your deposit, or a written statement of what is withheld and why, within <strong>14 days</strong> of the end of your tenancy (measured from the later of move-out or your forwarding address). On request, a full itemized accounting is due within <strong>45 days</strong>.
          </p>
          <p>
            South Dakota does not use a 2&times; multiplier. A landlord who fails to comply forfeits the right to withhold, and bad-faith retention exposes the landlord to:
          </p>
          <ul className="ml-6 list-disc space-y-2">
            <li>The <strong>full deposit</strong> wrongfully withheld</li>
            <li>Up to <strong>$200</strong> in punitive damages, plus court costs</li>
          </ul>
          <p>
        ...
        <div className="mx-auto max-w-4xl px-5 py-16 sm:px-8 sm:py-20">
          ...
          <div className="mt-8 grid gap-6 sm:grid-cols-2">
            ...
            <div>
              ...
              <p className="mt-2 text-sm text-slate-600">SDCL &sect; 43-32-24 and any others triggered by your circumstances &mdash; not generic legalese.</p>
            </div>
            <div>
              <h3 className="font-medium text-slate-900">Calculated penalty math</h3>
              <p className="mt-2 text-sm text-slate-600">The letter states the exact dollar amount you&apos;re entitled to demand &mdash; full deposit + up to $200 punitive damages + costs.</p>
            </div>
            <div>
