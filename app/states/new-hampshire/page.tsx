// app/states/new-hampshire/page.tsx
import type { Metadata } from 'next';
import Link from 'next/link';

const STATE = 'New Hampshire';
const DEADLINE = '30 days';
const STATUTE = 'RSA 540-A:7';
    ...
    <div className="min-h-screen bg-[#FAFAF7]" style={{ fontFamily: 'var(--font-sans)' }}>
      ...
      <section className="mx-auto max-w-4xl px-5 py-16 sm:px-8 sm:py-24">
        ...
        <p className="mt-6 max-w-2xl text-lg text-slate-700">
          A professional demand letter citing New Hampshire's security deposit statute (RSA 540-A:7), the 30-day return deadline, and the double-damages penalty for bad-faith withholding. Ready in minutes.
        </p>
      ...
      <section className="mx-auto max-w-4xl px-5 pb-16 sm:px-8">
        <div className="grid gap-4 sm:grid-cols-3">
          ...
          <div className="rounded-xl border border-[#E7E5E0] bg-white p-6">
            ...
            <p className="mt-1 text-sm text-slate-600">for bad-faith withholding under RSA 540-A:8</p>
          </div>
          <div className="rounded-xl border border-[#E7E5E0] bg-white p-6">
            <p className="text-xs font-semibold uppercase tracking-widest text-slate-500">Statute</p>
            <p className="mt-2 text-2xl font-medium text-slate-900" style={{ fontFamily: 'var(--font-display)' }}>540-A:7</p>
            <p className="mt-1 text-sm text-slate-600">New Hampshire Revised Statutes</p>
          </div>
        </div>
      </section>
      ...
      <section className="mx-auto max-w-3xl px-5 py-16 sm:px-8 sm:py-20">
        ...
        <div className="mt-8 space-y-6 text-slate-700">
          <p>
            Under <strong>RSA 540-A:7</strong>, your landlord has <strong>30 days</strong> after your tenancy ends to return your security deposit, with interest, along with a written, itemized statement of any deductions.
          </p>
          <p>
            If the landlord violates the statute in bad faith, you may recover under RSA 540-A:8:
          </p>
        ...
        <div className="mx-auto max-w-4xl px-5 py-16 sm:px-8 sm:py-20">
          ...
          <div className="mt-8 grid gap-6 sm:grid-cols-2">
            ...
            <div>
              ...
              <p className="mt-2 text-sm text-slate-600">RSA 540-A:7, 540-A:8 and any others triggered by your circumstances &mdash; not generic legalese.</p>
            </div>
            <div>
