// app/states/delaware/page.tsx
import type { Metadata } from 'next';
import Link from 'next/link';

const STATE = 'Delaware';
const DEADLINE = '20 days';
const STATUTE = '25 Del. C. § 5514';
const PENALTY = '2× the wrongfully withheld amount';

export const metadata: Metadata = {
  title: 'Security Deposit Demand Letter Delaware | TenantShield',
  ...
  alternates: {
    canonical: 'https://gettenantshield.com/states/delaware',
  },
};
    ...
    <div className="min-h-screen bg-[#FAFAF7]" style={{ fontFamily: 'var(--font-sans)' }}>
      ...
      <section className="mx-auto max-w-4xl px-5 py-16 sm:px-8 sm:py-24">
        ...
        <p className="mt-6 max-w-2xl text-lg text-slate-700">
          A professional demand letter citing Delaware's Residential Landlord-Tenant Code (25 Del. C. &sect; 5514), the 20-day return deadline, and the double-damages penalty. Ready in minutes.
        </p>
      ...
      <section className="mx-auto max-w-4xl px-5 pb-16 sm:px-8">
        <div className="grid gap-4 sm:grid-cols-3">
          ...
          <div className="rounded-xl border border-[#E7E5E0] bg-white p-6">
            ...
            <p className="mt-1 text-sm text-slate-600">for wrongful withholding under &sect; 5514</p>
          </div>
          <div className="rounded-xl border border-[#E7E5E0] bg-white p-6">
            <p className="text-xs font-semibold uppercase tracking-widest text-slate-500">Statute</p>
            <p className="mt-2 text-2xl font-medium text-slate-900" style={{ fontFamily: 'var(--font-display)' }}>§ 5514</p>
            <p className="mt-1 text-sm text-slate-600">Delaware Code, Title 25</p>
          </div>
        </div>
      </section>
      ...
      <section className="mx-auto max-w-3xl px-5 py-16 sm:px-8 sm:py-20">
        ...
        <div className="mt-8 space-y-6 text-slate-700">
          <p>
            Under <strong>25 Del. C. &sect; 5514</strong>, your landlord has <strong>20 days</strong> after your tenancy ends to return your security deposit or provide a written, itemized list of any deductions.
          </p>
          <p>
          ...
          <p className="rounded-lg border border-[#E7E5E0] bg-white p-5 text-sm text-slate-600">
            <strong className="text-slate-900">Good to know:</strong> If the landlord failed to disclose the bank or escrow account holding your deposit, that can also forfeit the landlord&apos;s right to keep any of it. There is no deposit cap for leases longer than one year.
          </p>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-4xl px-5 py-16 sm:px-8 sm:py-20">
          ...
          <div className="mt-8 grid gap-6 sm:grid-cols-2">
            ...
            <div>
              ...
              <p className="mt-2 text-sm text-slate-600">25 Del. C. &sect; 5514 and any others triggered by your circumstances &mdash; not generic legalese.</p>
            </div>
            <div>
              <h3 className="font-medium text-slate-900">Calculated penalty math</h3>
              <p className="mt-2 text-sm text-slate-600">The letter states the exact dollar amount you&apos;re entitled to demand &mdash; deposit + 2&times; the wrongfully withheld amount.</p>
            </div>
            <div>
