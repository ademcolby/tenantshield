// app/states/idaho/page.tsx
import type { Metadata } from 'next';
import Link from 'next/link';

const STATE = 'Idaho';
const DEADLINE = '21 days';
const STATUTE = 'Idaho Code § 6-321';
const PENALTY = 'up to 3× (treble) damages + attorney fees';

export const metadata: Metadata = {
  title: 'Security Deposit Demand Letter Idaho | TenantShield',
    ...
    <div className="min-h-screen bg-[#FAFAF7]" style={{ fontFamily: 'var(--font-sans)' }}>
      ...
      <section className="mx-auto max-w-4xl px-5 py-16 sm:px-8 sm:py-24">
        ...
        <p className="mt-6 max-w-2xl text-lg text-slate-700">
          A professional demand letter citing Idaho's security deposit statute (Idaho Code &sect; 6-321), the return deadline, and the treble-damages penalty for bad-faith withholding. Ready in minutes.
        </p>
      ...
      <section className="mx-auto max-w-4xl px-5 pb-16 sm:px-8">
        <div className="grid gap-4 sm:grid-cols-3">
          <div className="rounded-xl border border-[#E7E5E0] bg-white p-6">
            ...
            <p className="mt-1 text-sm text-slate-600">up to 30 if your lease specifies</p>
          </div>
          <div className="rounded-xl border border-[#E7E5E0] bg-white p-6">
          ...
          <div className="rounded-xl border border-[#E7E5E0] bg-white p-6">
            ...
            <p className="mt-2 text-2xl font-medium text-slate-900" style={{ fontFamily: 'var(--font-display)' }}>§ 6-321</p>
            <p className="mt-1 text-sm text-slate-600">Idaho Code</p>
          </div>
        </div>
      </section>
      ...
      <section className="mx-auto max-w-3xl px-5 py-16 sm:px-8 sm:py-20">
        ...
        <div className="mt-8 space-y-6 text-slate-700">
          <p>
            Under <strong>Idaho Code &sect; 6-321</strong>, your landlord has <strong>21 days</strong> after your tenancy ends to return your security deposit, or up to <strong>30 days</strong> if your lease specifies a longer period, along with a written, itemized statement of any deductions.
          </p>
          <p>
            If the landlord retains your deposit in <strong>bad faith</strong>, you may recover:
          </p>
          <ul className="ml-6 list-disc space-y-2">
            <li><strong>Up to three times</strong> (treble) the amount wrongfully withheld</li>
            <li><strong>Reasonable attorney&apos;s fees</strong></li>
          </ul>
          <p>
            So a $1,500 deposit wrongfully withheld can support a court judgment of up to <strong>$4,500 plus fees</strong>. Most landlords settle quickly once they realize you know the law.
          </p>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-4xl px-5 py-16 sm:px-8 sm:py-20">
          ...
          <div className="mt-8 grid gap-6 sm:grid-cols-2">
            ...
            <div>
              ...
              <p className="mt-2 text-sm text-slate-600">Idaho Code &sect; 6-321, &sect; 6-317 and any others triggered by your circumstances &mdash; not generic legalese.</p>
            </div>
            <div>
              <h3 className="font-medium text-slate-900">Calculated penalty math</h3>
              <p className="mt-2 text-sm text-slate-600">The letter states the exact dollar amount you&apos;re entitled to demand &mdash; deposit + up to 3&times; wrongful withholding + fees.</p>
            </div>
            <div>
