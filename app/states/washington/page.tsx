...
const STATUTE = 'RCW § 59.18.280';
const PENALTY = '2× wrongfully withheld amount + attorney fees + court costs';
    ...
    <div className="min-h-screen bg-[#FAFAF7]" style={{ fontFamily: 'var(--font-sans)' }}>
      ...
      <section className="mx-auto max-w-4xl px-5 py-16 sm:px-8 sm:py-24">
        ...
        <p className="mt-6 max-w-2xl text-lg text-slate-700">
          A professional demand letter citing {STATE}&apos;s Residential Landlord-Tenant Act (RCW &sect; 59.18.280), the 30-day return deadline, and the double-damages penalty for wrongful withholding. Ready in minutes.
        </p>
      ...
      <section className="mx-auto max-w-4xl px-5 pb-16 sm:px-8">
        <div className="grid gap-4 sm:grid-cols-3">
          ...
          <div className="rounded-xl border border-[#E7E5E0] bg-white p-6">
            ...
            <p className="mt-2 text-2xl font-medium text-slate-900" style={{ fontFamily: 'var(--font-display)' }}>&sect; 59.18.280</p>
            <p className="mt-1 text-sm text-slate-600">Revised Code of {STATE}</p>
          </div>
        </div>
      </section>
      ...
      <section className="mx-auto max-w-3xl px-5 py-16 sm:px-8 sm:py-20">
        ...
        <div className="mt-8 space-y-6 text-slate-700">
          <p>
            Under <strong>{STATUTE}</strong>, your landlord has <strong>30 days</strong> from the date you move out to return your security deposit or provide a written, itemized statement of any deductions. (This deadline was extended from 21 to 30 days by a 2023 amendment &mdash; many outdated sources still cite the old figure.)
          </p>
          <p>
            If the landlord fails to meet the deadline or withholds your deposit improperly, you may recover:
          </p>
          <ul className="ml-6 list-disc space-y-2">
            <li><strong>Up to two times</strong> the amount wrongfully withheld</li>
        ...
        <div className="mx-auto max-w-4xl px-5 py-16 sm:px-8 sm:py-20">
          ...
          <div className="mt-8 grid gap-6 sm:grid-cols-2">
            ...
            <div>
              ...
              <p className="mt-2 text-sm text-slate-600">RCW &sect; 59.18.280 and any others triggered by your circumstances &mdash; with the current 30-day deadline, not the outdated 21-day figure.</p>
            </div>
            <div>
              <h3 className="font-medium text-slate-900">Calculated penalty math</h3>
              <p className="mt-2 text-sm text-slate-600">The letter states the exact dollar amount you&apos;re entitled to demand &mdash; deposit + up to 2&times; wrongful withholding + fees.</p>
            </div>
            <div>
