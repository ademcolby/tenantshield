// app/states/connecticut/page.tsx
import type { Metadata } from 'next';
import Link from 'next/link';

const STATE = 'Connecticut';
const DEADLINE = '30 days';
const STATUTE = 'Conn. Gen. Stat. § 47a-21';
const PENALTY = '2× the wrongfully withheld amount + interest';

export const metadata: Metadata = {
  title: 'Security Deposit Demand Letter Connecticut | TenantShield',
    ...
    <div className="min-h-screen bg-[#FAFAF7]" style={{ fontFamily: 'var(--font-sans)' }}>
      ...
      <section className="mx-auto max-w-4xl px-5 py-16 sm:px-8 sm:py-24">
        ...
        <p className="mt-6 max-w-2xl text-lg text-slate-700">
          A professional demand letter citing Connecticut's security deposit statute (Conn. Gen. Stat. &sect; 47a-21), the return deadline, and the double-damages penalty plus interest. Ready in minutes.
        </p>
      ...
      <section className="mx-auto max-w-4xl px-5 pb-16 sm:px-8">
        <div className="grid gap-4 sm:grid-cols-3">
          ...
          <div className="rounded-xl border border-[#E7E5E0] bg-white p-6">
            ...
            <p className="mt-1 text-sm text-slate-600">for wrongful withholding, plus accrued interest</p>
          </div>
          <div className="rounded-xl border border-[#E7E5E0] bg-white p-6">
            <p className="text-xs font-semibold uppercase tracking-widest text-slate-500">Statute</p>
            <p className="mt-2 text-2xl font-medium text-slate-900" style={{ fontFamily: 'var(--font-display)' }}>§ 47a-21</p>
            <p className="mt-1 text-sm text-slate-600">Connecticut General Statutes</p>
          </div>
        </div>
      </section>
      ...
      <section className="mx-auto max-w-3xl px-5 py-16 sm:px-8 sm:py-20">
        ...
        <div className="mt-8 space-y-6 text-slate-700">
          <p>
            Under <strong>Conn. Gen. Stat. &sect; 47a-21</strong>, your landlord must return your deposit, with interest, within <strong>30 days</strong> of the end of your tenancy <strong>or 15 days after you provide a forwarding address &mdash; whichever is later</strong>, along with a written, itemized statement of any deductions.
          </p>
          <p>
            If the landlord wrongfully withholds your deposit, you may recover:
          </p>
          <ul className="ml-6 list-disc space-y-2">
            <li><strong>Twice</strong> the amount wrongfully withheld</li>
            <li>Your deposit plus all <strong>accrued interest</strong></li>
          </ul>
          <p>
        ...
        <div className="mx-auto max-w-4xl px-5 py-16 sm:px-8 sm:py-20">
          ...
          <div className="mt-8 grid gap-6 sm:grid-cols-2">
            ...
            <div>
              ...
              <p className="mt-2 text-sm text-slate-600">Conn. Gen. Stat. &sect; 47a-21 and any others triggered by your circumstances &mdash; not generic legalese.</p>
            </div>
            <div>
              <h3 className="font-medium text-slate-900">Calculated penalty math</h3>
              <p className="mt-2 text-sm text-slate-600">The letter states the exact dollar amount you&apos;re entitled to demand &mdash; deposit + 2&times; wrongful withholding + accrued interest.</p>
            </div>
            <div>
