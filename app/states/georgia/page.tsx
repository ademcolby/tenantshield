...
const STATUTE = 'OCGA § 44-7-34 & § 44-7-35';
    ...
    <div className="min-h-screen bg-[#FAFAF7]" style={{ fontFamily: 'var(--font-sans)' }}>
      ...
      <section className="mx-auto max-w-4xl px-5 py-16 sm:px-8 sm:py-24">
        ...
        <p className="mt-6 max-w-2xl text-lg text-slate-700">
          A professional demand letter citing {STATE}&apos;s deposit statutes (OCGA &sect; 44-7-34 and &sect; 44-7-35), the 30-day return deadline, and the triple-damages penalty for bad-faith withholding. Ready in minutes.
        </p>
      ...
      <section className="mx-auto max-w-4xl px-5 pb-16 sm:px-8">
        <div className="grid gap-4 sm:grid-cols-3">
          ...
          <div className="rounded-xl border border-[#E7E5E0] bg-white p-6">
            ...
            <p className="mt-1 text-sm text-slate-600">for bad-faith withholding under &sect; 44-7-35</p>
          </div>
          <div className="rounded-xl border border-[#E7E5E0] bg-white p-6">
            <p className="text-xs font-semibold uppercase tracking-widest text-slate-500">Statute</p>
            <p className="mt-2 text-2xl font-medium text-slate-900" style={{ fontFamily: 'var(--font-display)' }}>&sect; 44-7-34</p>
            <p className="mt-1 text-sm text-slate-600">Official Code of {STATE}</p>
          </div>
        </div>
      </section>
      ...
      <section className="mx-auto max-w-3xl px-5 py-16 sm:px-8 sm:py-20">
        ...
        <div className="mt-8 space-y-6 text-slate-700">
          <p>
            Under <strong>OCGA &sect; 44-7-34</strong>, your landlord has <strong>30 days</strong> from the date you move out to return your security deposit or provide a written, itemized list of deductions.
          </p>
          <p>
            If the landlord withholds your deposit in <strong>bad faith</strong> &mdash; for example, refusing to return it, providing no itemization, or making clearly improper deductions &mdash; OCGA &sect; 44-7-35 allows you to recover:
          </p>
          ...
          <p>
            So a $1,500 deposit wrongfully withheld can support a court judgment of <strong>$4,500 plus fees</strong>. Most landlords settle quickly once they realize you know the law.
          </p>
          <p className="rounded-lg border border-[#E7E5E0] bg-white p-5 text-sm text-slate-600">
            <strong className="text-slate-900">Good to know:</strong> As of July 1, 2024, {STATE} caps security deposits at <strong>two months&apos; rent</strong>. If you were charged more than that, your letter can raise it.
          </p>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-4xl px-5 py-16 sm:px-8 sm:py-20">
          ...
          <div className="mt-8 grid gap-6 sm:grid-cols-2">
            ...
            <div>
              ...
              <p className="mt-2 text-sm text-slate-600">OCGA &sect; 44-7-34, &sect; 44-7-35, and any others triggered by your circumstances &mdash; not generic legalese.</p>
            </div>
            <div>
              <h3 className="font-medium text-slate-900">Calculated penalty math</h3>
              <p className="mt-2 text-sm text-slate-600">The letter states the exact dollar amount you&apos;re entitled to demand &mdash; deposit + 3&times; wrongful withholding + fees.</p>
            </div>
            <div>
