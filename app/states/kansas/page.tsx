// app/states/kansas/page.tsx
import type { Metadata } from 'next';
import Link from 'next/link';

const STATE = 'Kansas';
const DEADLINE = '30 days';
const STATUTE = 'K.S.A. § 58-2550';
const PENALTY = '1.5× the wrongfully withheld amount';

export const metadata: Metadata = {
  title: 'Security Deposit Demand Letter Kansas | TenantShield',
    ...
    <div className="min-h-screen bg-[#FAFAF7]" style={{ fontFamily: 'var(--font-sans)' }}>
      ...
      <section className="mx-auto max-w-4xl px-5 py-16 sm:px-8 sm:py-24">
        ...
        <p className="mt-6 max-w-2xl text-lg text-slate-700">
          A professional demand letter citing Kansas's Residential Landlord and Tenant Act (K.S.A. &sect; 58-2550), the 30-day return deadline, and the one-and-a-half-times penalty for wrongful withholding. Ready in minutes.
        </p>
      ...
      <section className="mx-auto max-w-4xl px-5 pb-16 sm:px-8">
        <div className="grid gap-4 sm:grid-cols-3">
          ...
          <div className="rounded-xl border border-[#E7E5E0] bg-white p-6">
            ...
            <p className="mt-1 text-sm text-slate-600">for wrongful withholding under &sect; 58-2550</p>
          </div>
          <div className="rounded-xl border border-[#E7E5E0] bg-white p-6">
            <p className="text-xs font-semibold uppercase tracking-widest text-slate-500">Statute</p>
            <p className="mt-2 text-2xl font-medium text-slate-900" style={{ fontFamily: 'var(--font-display)' }}>§ 58-2550</p>
            <p className="mt-1 text-sm text-slate-600">Kansas Statutes Annotated</p>
          </div>
        </div>
      </section>
      ...
      <section className="mx-auto max-w-3xl px-5 py-16 sm:px-8 sm:py-20">
        ...
        <div className="mt-8 space-y-6 text-slate-700">
          <p>
            Under <strong>K.S.A. &sect; 58-2550</strong>, your landlord must return your security deposit within <strong>14 days after determining the amount of any deductions, but no more than 30 days</strong> after your tenancy ends, along with a written, itemized statement.
          </p>
          <p>
        ...
        <div className="mx-auto max-w-4xl px-5 py-16 sm:px-8 sm:py-20">
          ...
          <div className="mt-8 grid gap-6 sm:grid-cols-2">
            ...
            <div>
              ...
              <p className="mt-2 text-sm text-slate-600">K.S.A. &sect; 58-2550 and any others triggered by your circumstances &mdash; not generic legalese.</p>
            </div>
            <div>
