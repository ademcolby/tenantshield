    ...
    <div className="min-h-screen bg-[#FAFAF7]" style={{ fontFamily: 'var(--font-sans)' }}>
      ...
      <section className="mx-auto max-w-4xl px-5 pb-16 sm:px-8">
        <div className="grid gap-4 sm:grid-cols-3">
          ...
          <div className="rounded-xl border border-[#E7E5E0] bg-white p-6">
            ...
            <p className="mt-1 text-sm text-slate-600">for bad-faith withholding under &sect; 92.109</p>
          </div>
          <div className="rounded-xl border border-[#E7E5E0] bg-white p-6">
            <p className="text-xs font-semibold uppercase tracking-widest text-slate-500">Statute</p>
            <p className="mt-2 text-2xl font-medium text-slate-900" style={{ fontFamily: 'var(--font-display)' }}>&sect; 92.103</p>
            <p className="mt-1 text-sm text-slate-600">{STATE} Property Code</p>
          </div>
        </div>
      </section>
      ...
      <section className="mx-auto max-w-3xl px-5 py-16 sm:px-8 sm:py-20">
        ...
        <div className="mt-8 space-y-6 text-slate-700">
          <p>
            Under <strong>{STATUTE}</strong>, your landlord has <strong>30 days</strong> from the date you surrender the property to return your security deposit or provide a written, itemized list of deductions.
          </p>
          <p>
            If the landlord acts in <strong>bad faith</strong> &mdash; for example, refusing to return the deposit, providing no itemization, or making clearly improper deductions &mdash; Texas Property Code &sect; 92.109 allows you to recover:
          </p>
          <ul className="ml-6 list-disc space-y-2">
            <li>A statutory penalty of <strong>$100</strong></li>
            <li><strong>Three times</strong> the portion of the deposit wrongfully withheld</li>
            <li><strong>Reasonable attorney&apos;s fees</strong></li>
          </ul>
          <p>
            So a $1,500 deposit wrongfully withheld in full can result in a court judgment of <strong>$4,600 plus fees</strong>. Most landlords settle quickly once they realize you know the law.
          </p>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-4xl px-5 py-16 sm:px-8 sm:py-20">
          ...
          <div className="mt-8 grid gap-6 sm:grid-cols-2">
            <div>
              ...
              <p className="mt-2 text-sm text-slate-600">Properly formatted, addressed to your landlord by name, citing the exact Texas statutes that apply to your situation.</p>
            </div>
            <div>
              <h3 className="font-medium text-slate-900">Specific statute citations</h3>
              <p className="mt-2 text-sm text-slate-600">Texas Property Code &sect; 92.103, &sect; 92.109, and any others triggered by your circumstances &mdash; not generic legalese.</p>
            </div>
            <div>
              <h3 className="font-medium text-slate-900">Calculated penalty math</h3>
              <p className="mt-2 text-sm text-slate-600">The letter computes the exact dollar amount you&apos;re entitled to demand &mdash; deposit + $100 + 3&times; wrongful withholding.</p>
            </div>
            <div>
