// app/states/mississippi/page.tsx
import type { Metadata } from 'next';
import Link from 'next/link';

const STATE = 'Mississippi';
const DEADLINE = '45 days';
const STATUTE = 'Miss. Code § 89-8-21';
const PENALTY = 'up to $200 statutory damages + actual damages + costs';

export const metadata: Metadata = {
  title: 'Security Deposit Demand Letter Mississippi | TenantShield',
    ...
    <div className="min-h-screen bg-[#FAFAF7]" style={{ fontFamily: 'var(--font-sans)' }}>
      ...
      <section className="mx-auto max-w-4xl px-5 py-16 sm:px-8 sm:py-24">
        ...
        <p className="mt-6 max-w-2xl text-lg text-slate-700">
          A professional demand letter citing Mississippi's deposit statute (Miss. Code &sect; 89-8-21), the 45-day return deadline, and the statutory damages for bad-faith withholding. Ready in minutes.
        </p>
      ...
      <section className="mx-auto max-w-4xl px-5 pb-16 sm:px-8">
        <div className="grid gap-4 sm:grid-cols-3">
          ...
          <div className="rounded-xl border border-[#E7E5E0] bg-white p-6">
            ...
            <p className="mt-2 text-2xl font-medium text-slate-900" style={{ fontFamily: 'var(--font-display)' }}>$200 + actual</p>
            <p className="mt-1 text-sm text-slate-600">for bad-faith withholding under &sect; 89-8-21</p>
          </div>
          <div className="rounded-xl border border-[#E7E5E0] bg-white p-6">
            <p className="text-xs font-semibold uppercase tracking-widest text-slate-500">Statute</p>
            <p className="mt-2 text-2xl font-medium text-slate-900" style={{ fontFamily: 'var(--font-display)' }}>§ 89-8-21</p>
            <p className="mt-1 text-sm text-slate-600">Mississippi Code</p>
          </div>
        </div>
      </section>
      ...
      <section className="mx-auto max-w-3xl px-5 py-16 sm:px-8 sm:py-20">
        ...
        <div className="mt-8 space-y-6 text-slate-700">
          <p>
            Under <strong>Miss. Code &sect; 89-8-21</strong>, your landlord has <strong>45 days</strong> after your tenancy ends and you make a demand to return your security deposit or provide a written, itemized list of any deductions.
          </p>
          <p>
            If the landlord wrongfully withholds your deposit in bad faith, you may recover:
          </p>
          <ul className="ml-6 list-disc space-y-2">
            <li><strong>Up to $200</strong> in statutory damages</li>
            <li>Your <strong>actual damages</strong> and court costs</li>
          </ul>
          <p>
            So a $1,500 deposit wrongfully withheld can support a judgment for the deposit plus up to <strong>$200 in damages and costs</strong>. Most landlords settle quickly once they realize you know the law.
          </p>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-4xl px-5 py-16 sm:px-8 sm:py-20">
          ...
          <div className="mt-8 grid gap-6 sm:grid-cols-2">
            ...
            <div>
              ...
              <p className="mt-2 text-sm text-slate-600">Miss. Code &sect; 89-8-21 and any others triggered by your circumstances &mdash; not generic legalese.</p>
            </div>
            <div>
              <h3 className="font-medium text-slate-900">Calculated penalty math</h3>
              <p className="mt-2 text-sm text-slate-600">The letter states the exact dollar amount you&apos;re entitled to demand &mdash; return of your deposit + up to $200 statutory damages + costs.</p>
            </div>
            <div>
