// app/states/arkansas/page.tsx
import type { Metadata } from 'next';
import Link from 'next/link';

const STATE = 'Arkansas';
const DEADLINE = '60 days';
const STATUTE = 'Ark. Code § 18-16-305 & § 18-16-306';
const PENALTY = 'up to 2× wrongfully withheld + attorney fees';
    ...
    <div className="min-h-screen bg-[#FAFAF7]" style={{ fontFamily: 'var(--font-sans)' }}>
      ...
      <section className="mx-auto max-w-4xl px-5 py-16 sm:px-8 sm:py-24">
        ...
        <p className="mt-6 max-w-2xl text-lg text-slate-700">
          A professional demand letter citing Arkansas's security deposit statute (Ark. Code &sect; 18-16-305 and &sect; 18-16-306), the 60-day return deadline, and the double-damages penalty. Ready in minutes.
        </p>
      ...
      <section className="mx-auto max-w-4xl px-5 pb-16 sm:px-8">
        <div className="grid gap-4 sm:grid-cols-3">
          ...
          <div className="rounded-xl border border-[#E7E5E0] bg-white p-6">
            ...
            <p className="mt-1 text-sm text-slate-600">for wrongful withholding under &sect; 18-16-306</p>
          </div>
          <div className="rounded-xl border border-[#E7E5E0] bg-white p-6">
            <p className="text-xs font-semibold uppercase tracking-widest text-slate-500">Statute</p>
            <p className="mt-2 text-2xl font-medium text-slate-900" style={{ fontFamily: 'var(--font-display)' }}>§ 18-16-305</p>
            <p className="mt-1 text-sm text-slate-600">Arkansas Code Annotated</p>
          </div>
        </div>
      </section>
      ...
      <section className="mx-auto max-w-3xl px-5 py-16 sm:px-8 sm:py-20">
        ...
        <div className="mt-8 space-y-6 text-slate-700">
          <p>
            Under <strong>Ark. Code &sect; 18-16-305</strong>, a covered landlord has <strong>60 days</strong> after your tenancy ends to return your security deposit or provide a written, itemized statement of any deductions.
          </p>
          <p>
            Where the statute applies, a landlord who wrongfully withholds your deposit is liable under &sect; 18-16-306 for:
          </p>
        ...
        <div className="mx-auto max-w-4xl px-5 py-16 sm:px-8 sm:py-20">
          ...
          <div className="mt-8 grid gap-6 sm:grid-cols-2">
            ...
            <div>
              ...
              <p className="mt-2 text-sm text-slate-600">Ark. Code &sect; 18-16-305, &sect; 18-16-306 and any others triggered by your circumstances &mdash; not generic legalese.</p>
            </div>
            <div>
              <h3 className="font-medium text-slate-900">Calculated penalty math</h3>
              <p className="mt-2 text-sm text-slate-600">The letter states the exact dollar amount you&apos;re entitled to demand &mdash; deposit + up to 2&times; wrongful withholding + fees, where the statute applies.</p>
            </div>
            <div>
