// app/states/montana/page.tsx
import type { Metadata } from 'next';
import Link from 'next/link';

const STATE = 'Montana';
const DEADLINE = '10 / 30 days';
const STATUTE = 'Mont. Code § 70-25-202 & § 70-25-204';
const PENALTY = '2× the wrongfully withheld amount + attorney fees';

export const metadata: Metadata = {
  title: 'Security Deposit Demand Letter Montana | TenantShield',
    ...
    <div className="min-h-screen bg-[#FAFAF7]" style={{ fontFamily: 'var(--font-sans)' }}>
      ...
      <section className="mx-auto max-w-4xl px-5 py-16 sm:px-8 sm:py-24">
        ...
        <p className="mt-6 max-w-2xl text-lg text-slate-700">
          A professional demand letter citing Montana's security deposit statute (Mont. Code &sect; 70-25-202 and &sect; 70-25-204), the return deadlines, and the double-damages penalty. Ready in minutes.
        </p>
      ...
      <section className="mx-auto max-w-4xl px-5 pb-16 sm:px-8">
        <div className="grid gap-4 sm:grid-cols-3">
          <div className="rounded-xl border border-[#E7E5E0] bg-white p-6">
            ...
            <p className="mt-1 text-sm text-slate-600">10 if no deductions, 30 with an itemized list</p>
          </div>
          <div className="rounded-xl border border-[#E7E5E0] bg-white p-6">
            ...
            <p className="mt-1 text-sm text-slate-600">for bad-faith withholding under &sect; 70-25-204</p>
          </div>
          <div className="rounded-xl border border-[#E7E5E0] bg-white p-6">
            <p className="text-xs font-semibold uppercase tracking-widest text-slate-500">Statute</p>
            <p className="mt-2 text-2xl font-medium text-slate-900" style={{ fontFamily: 'var(--font-display)' }}>§ 70-25-202</p>
            <p className="mt-1 text-sm text-slate-600">Montana Code Annotated</p>
          </div>
        </div>
      </section>
      ...
      <section className="mx-auto max-w-3xl px-5 py-16 sm:px-8 sm:py-20">
        ...
        <div className="mt-8 space-y-6 text-slate-700">
          <p>
            Under <strong>Mont. Code &sect; 70-25-202</strong>, your landlord must return your deposit within <strong>10 days</strong> if there are no deductions, or within <strong>30 days</strong> with a written, itemized statement if any deductions are claimed.
          </p>
          <p>
            If the landlord withholds your deposit in <strong>bad faith</strong>, you may recover under &sect; 70-25-204:
          </p>
          <ul className="ml-6 list-disc space-y-2">
            <li>The amount wrongfully withheld plus an <strong>equal amount as a penalty</strong> (effectively 2&times;)</li>
        ...
        <div className="mx-auto max-w-4xl px-5 py-16 sm:px-8 sm:py-20">
          ...
          <div className="mt-8 grid gap-6 sm:grid-cols-2">
            ...
            <div>
              ...
              <p className="mt-2 text-sm text-slate-600">Mont. Code &sect; 70-25-202, &sect; 70-25-204 and any others triggered by your circumstances &mdash; not generic legalese.</p>
            </div>
            <div>
              <h3 className="font-medium text-slate-900">Calculated penalty math</h3>
              <p className="mt-2 text-sm text-slate-600">The letter states the exact dollar amount you&apos;re entitled to demand &mdash; deposit + an equal penalty amount (2&times;) + fees.</p>
            </div>
            <div>
