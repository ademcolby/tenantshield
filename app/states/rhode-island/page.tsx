// app/states/rhode-island/page.tsx
import type { Metadata } from 'next';
import Link from 'next/link';

const STATE = 'Rhode Island';
const DEADLINE = '20 days';
const STATUTE = 'R.I. Gen. Laws § 34-18-19';
    ...
    <div className="min-h-screen bg-[#FAFAF7]" style={{ fontFamily: 'var(--font-sans)' }}>
      ...
      <section className="mx-auto max-w-4xl px-5 py-16 sm:px-8 sm:py-24">
        ...
        <p className="mt-6 max-w-2xl text-lg text-slate-700">
          A professional demand letter citing Rhode Island's Residential Landlord and Tenant Act (R.I. Gen. Laws &sect; 34-18-19), the 20-day return deadline, and the double-damages penalty. Ready in minutes.
        </p>
      ...
      <section className="mx-auto max-w-4xl px-5 pb-16 sm:px-8">
        <div className="grid gap-4 sm:grid-cols-3">
          ...
          <div className="rounded-xl border border-[#E7E5E0] bg-white p-6">
            ...
            <p className="mt-1 text-sm text-slate-600">for bad-faith withholding under &sect; 34-18-19</p>
          </div>
          <div className="rounded-xl border border-[#E7E5E0] bg-white p-6">
            <p className="text-xs font-semibold uppercase tracking-widest text-slate-500">Statute</p>
            <p className="mt-2 text-2xl font-medium text-slate-900" style={{ fontFamily: 'var(--font-display)' }}>§ 34-18-19</p>
            <p className="mt-1 text-sm text-slate-600">Rhode Island General Laws</p>
          </div>
        </div>
      </section>
      ...
      <section className="mx-auto max-w-3xl px-5 py-16 sm:px-8 sm:py-20">
        ...
        <div className="mt-8 space-y-6 text-slate-700">
          <p>
            Under <strong>R.I. Gen. Laws &sect; 34-18-19</strong>, your landlord has <strong>20 days</strong> after your tenancy ends and you provide a forwarding address to return your security deposit or provide a written, itemized statement of any deductions.
          </p>
          <p>
          ...
          <ul className="ml-6 list-disc space-y-2">
            ...
            <li>Plus your reasonable attorney&apos;s fees</li>
          </ul>
          <p>
        ...
        <div className="mx-auto max-w-4xl px-5 py-16 sm:px-8 sm:py-20">
          ...
          <div className="mt-8 grid gap-6 sm:grid-cols-2">
            ...
            <div>
              ...
              <p className="mt-2 text-sm text-slate-600">R.I. Gen. Laws &sect; 34-18-19 and any others triggered by your circumstances &mdash; not generic legalese.</p>
            </div>
            <div>
