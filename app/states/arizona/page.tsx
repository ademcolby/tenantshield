...
const STATE = 'Arizona';
const DEADLINE = '14 business days';
const STATUTE = 'ARS § 33-1321';
const PENALTY = '2× wrongfully withheld amount';
    ...
    <div className="min-h-screen bg-[#FAFAF7]" style={{ fontFamily: 'var(--font-sans)' }}>
      ...
      <section className="mx-auto max-w-4xl px-5 py-16 sm:px-8 sm:py-24">
        ...
        <p className="mt-6 max-w-2xl text-lg text-slate-700">
          A professional demand letter citing {STATE}&apos;s Residential Landlord and Tenant Act (ARS &sect; 33-1321), the 14-business-day return deadline, and the double-damages penalty for wrongful withholding. Ready in minutes.
        </p>
      ...
      <section className="mx-auto max-w-4xl px-5 pb-16 sm:px-8">
        <div className="grid gap-4 sm:grid-cols-3">
          ...
          <div className="rounded-xl border border-[#E7E5E0] bg-white p-6">
            ...
            <p className="mt-2 text-2xl font-medium text-slate-900" style={{ fontFamily: 'var(--font-display)' }}>&sect; 33-1321</p>
      ...
      <section className="mx-auto max-w-3xl px-5 py-16 sm:px-8 sm:py-20">
        ...
        <div className="mt-8 space-y-6 text-slate-700">
          <p>
            Under <strong>{STATUTE}</strong>, your landlord has <strong>14 business days</strong> (weekends and holidays do not count) to return your security deposit or provide a written, itemized list of deductions &mdash; measured from the later of when your tenancy ends, you hand back possession, and you make a written demand for the deposit.
          </p>
          <p>
            If the landlord wrongfully withholds any part of your deposit, you may recover:
          </p>
          <ul className="ml-6 list-disc space-y-2">
            <li>The property or money owed to you, plus</li>
          ...
          <p className="rounded-lg border border-[#E7E5E0] bg-white p-5 text-sm text-slate-600">
            <strong className="text-slate-900">Good to know:</strong> {STATE} caps security deposits at <strong>one and one-half months&apos; rent</strong>. The 14-business-day clock only starts once you have made a written demand &mdash; which your letter provides.
          </p>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-4xl px-5 py-16 sm:px-8 sm:py-20">
          ...
          <div className="mt-8 grid gap-6 sm:grid-cols-2">
            ...
            <div>
              ...
              <p className="mt-2 text-sm text-slate-600">ARS &sect; 33-1321 and any others triggered by your circumstances &mdash; not generic legalese.</p>
            </div>
            <div>
              <h3 className="font-medium text-slate-900">Calculated penalty math</h3>
              <p className="mt-2 text-sm text-slate-600">The letter states the exact dollar amount you&apos;re entitled to demand &mdash; deposit + 2&times; wrongful withholding &mdash; and serves as your written demand.</p>
            </div>
            <div>
