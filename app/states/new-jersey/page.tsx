// app/states/new-jersey/page.tsx
import type { Metadata } from 'next';
import Link from 'next/link';

const STATE = 'New Jersey';
const DEADLINE = '30 days';
const STATUTE = 'NJSA § 46:8-21.1';
const PENALTY = '2× the amount due + court costs + attorney fees';
    ...
    <div className="min-h-screen bg-[#FAFAF7]" style={{ fontFamily: 'var(--font-sans)' }}>
      ...
      <section className="mx-auto max-w-4xl px-5 py-16 sm:px-8 sm:py-24">
        ...
        <p className="mt-6 max-w-2xl text-lg text-slate-700">
          A professional demand letter citing {STATE}&apos;s Rent Security Deposit Act (NJSA &sect; 46:8-21.1), the 30-day return deadline, and the double-damages penalty for wrongful withholding. Ready in minutes.
        </p>
      ...
      <section className="mx-auto max-w-4xl px-5 pb-16 sm:px-8">
        <div className="grid gap-4 sm:grid-cols-3">
          ...
          <div className="rounded-xl border border-[#E7E5E0] bg-white p-6">
            ...
            <p className="mt-2 text-2xl font-medium text-slate-900" style={{ fontFamily: 'var(--font-display)' }}>&sect; 46:8-21.1</p>
      ...
      <section className="mx-auto max-w-3xl px-5 py-16 sm:px-8 sm:py-20">
        ...
        <div className="mt-8 space-y-6 text-slate-700">
          <p>
            Under <strong>{STATUTE}</strong>, your landlord has <strong>30 days</strong> after your tenancy ends to return your security deposit, with interest, along with a written, itemized statement of any deductions.
          </p>
          <p>
            If the landlord wrongfully withholds any part of your deposit, the court must award you:
          </p>
          <ul className="ml-6 list-disc space-y-2">
            <li><strong>Double</strong> the amount wrongfully withheld</li>
            <li><strong>Court costs</strong></li>
            <li><strong>Reasonable attorney&apos;s fees</strong></li>
          </ul>
          <p>
            So a $1,500 deposit wrongfully withheld can support a court judgment of <strong>$3,000 plus court costs and fees</strong>. {STATE}&apos;s double-damages award is mandatory, not discretionary &mdash; most landlords settle quickly once they realize that.
          </p>
          <p className="rounded-lg border border-[#E7E5E0] bg-white p-5 text-sm text-slate-600">
            <strong className="text-slate-900">Good to know:</strong> {STATE} caps security deposits at <strong>one and one-half months&apos; rent</strong> and requires the deposit to be held in an interest-bearing account, with the interest paid or credited to you annually.
          </p>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-4xl px-5 py-16 sm:px-8 sm:py-20">
          ...
          <div className="mt-8 grid gap-6 sm:grid-cols-2">
            ...
            <div>
              ...
              <p className="mt-2 text-sm text-slate-600">NJSA &sect; 46:8-21.1 and any others triggered by your circumstances &mdash; not generic legalese.</p>
            </div>
            <div>
              <h3 className="font-medium text-slate-900">Calculated penalty math</h3>
              <p className="mt-2 text-sm text-slate-600">The letter states the exact dollar amount you&apos;re entitled to demand &mdash; double the wrongful withholding + court costs and fees.</p>
            </div>
            <div>
