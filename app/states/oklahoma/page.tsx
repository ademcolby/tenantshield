// app/states/oklahoma/page.tsx
import type { Metadata } from 'next';
import Link from 'next/link';

const STATE = 'Oklahoma';
const DEADLINE = '45 days';
const STATUTE = '41 O.S. § 115';
const PENALTY = 'actual damages + court costs';

export const metadata: Metadata = {
  title: 'Security Deposit Demand Letter Oklahoma | TenantShield',
    ...
    <div className="min-h-screen bg-[#FAFAF7]" style={{ fontFamily: 'var(--font-sans)' }}>
      ...
      <section className="mx-auto max-w-4xl px-5 py-16 sm:px-8 sm:py-24">
        ...
        <p className="mt-6 max-w-2xl text-lg text-slate-700">
          A professional demand letter citing Oklahoma's Residential Landlord and Tenant Act (41 O.S. &sect; 115), the 45-day return deadline, and the remedies for bad-faith withholding. Ready in minutes.
        </p>
      ...
      <section className="mx-auto max-w-4xl px-5 pb-16 sm:px-8">
        <div className="grid gap-4 sm:grid-cols-3">
          <div className="rounded-xl border border-[#E7E5E0] bg-white p-6">
            ...
            <p className="mt-1 text-sm text-slate-600">after your written demand for the deposit</p>
          </div>
          <div className="rounded-xl border border-[#E7E5E0] bg-white p-6">
            <p className="text-xs font-semibold uppercase tracking-widest text-slate-500">Remedy</p>
            <p className="mt-2 text-2xl font-medium text-slate-900" style={{ fontFamily: 'var(--font-display)' }}>Actual + costs</p>
            <p className="mt-1 text-sm text-slate-600">plus return of the wrongfully withheld deposit</p>
          </div>
          <div className="rounded-xl border border-[#E7E5E0] bg-white p-6">
            <p className="text-xs font-semibold uppercase tracking-widest text-slate-500">Statute</p>
            <p className="mt-2 text-2xl font-medium text-slate-900" style={{ fontFamily: 'var(--font-display)' }}>§ 115</p>
            <p className="mt-1 text-sm text-slate-600">Oklahoma Statutes, Title 41</p>
          </div>
        </div>
      </section>
      ...
      <section className="mx-auto max-w-3xl px-5 py-16 sm:px-8 sm:py-20">
        ...
        <div className="mt-8 space-y-6 text-slate-700">
          <p>
            Under <strong>41 O.S. &sect; 115</strong>, your landlord has <strong>45 days</strong> after your tenancy ends, you deliver possession, and you make a written demand to return your security deposit or provide a written, itemized accounting of any deductions.
          </p>
          <p>
            Oklahoma does not use a 2&times; or 3&times; multiplier. A landlord who in bad faith retains your deposit must return it and is also liable for:
          </p>
          <ul className="ml-6 list-disc space-y-2">
            <li>The <strong>full deposit</strong> wrongfully withheld</li>
            <li>Your <strong>court costs</strong></li>
          </ul>
          <p>
        ...
        <div className="mx-auto max-w-4xl px-5 py-16 sm:px-8 sm:py-20">
          ...
          <div className="mt-8 grid gap-6 sm:grid-cols-2">
            ...
            <div>
              ...
              <p className="mt-2 text-sm text-slate-600">41 O.S. &sect; 115 and any others triggered by your circumstances &mdash; not generic legalese.</p>
            </div>
            <div>
              <h3 className="font-medium text-slate-900">The right legal theory</h3>
              <p className="mt-2 text-sm text-slate-600">The letter presses Oklahoma&apos;s requirement that a bad-faith landlord return the full deposit plus your court costs.</p>
            </div>
            <div>
