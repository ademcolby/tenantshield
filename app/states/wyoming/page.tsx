// app/states/wyoming/page.tsx
import type { Metadata } from 'next';
import Link from 'next/link';

const STATE = 'Wyoming';
const DEADLINE = '30 days';
const STATUTE = 'Wyo. Stat. § 1-21-1208';
const PENALTY = 'full deposit + court costs (no multiplier)';

export const metadata: Metadata = {
  title: 'Security Deposit Demand Letter Wyoming | TenantShield',
    ...
    <div className="min-h-screen bg-[#FAFAF7]" style={{ fontFamily: 'var(--font-sans)' }}>
      ...
      <section className="mx-auto max-w-4xl px-5 py-16 sm:px-8 sm:py-24">
        ...
        <p className="mt-6 max-w-2xl text-lg text-slate-700">
          A professional demand letter citing Wyoming's Residential Rental Property Act (Wyo. Stat. &sect; 1-21-1208), the return deadline, and the remedies for wrongful withholding. Ready in minutes.
        </p>
      ...
      <section className="mx-auto max-w-4xl px-5 pb-16 sm:px-8">
        <div className="grid gap-4 sm:grid-cols-3">
          <div className="rounded-xl border border-[#E7E5E0] bg-white p-6">
            ...
            <p className="mt-1 text-sm text-slate-600">or 15 days after a forwarding address (later)</p>
          </div>
          <div className="rounded-xl border border-[#E7E5E0] bg-white p-6">
            ...
            <p className="mt-1 text-sm text-slate-600">full deposit plus court costs</p>
          </div>
          <div className="rounded-xl border border-[#E7E5E0] bg-white p-6">
            <p className="text-xs font-semibold uppercase tracking-widest text-slate-500">Statute</p>
            <p className="mt-2 text-2xl font-medium text-slate-900" style={{ fontFamily: 'var(--font-display)' }}>§ 1-21-1208</p>
            <p className="mt-1 text-sm text-slate-600">Wyoming Statutes</p>
          </div>
        </div>
      </section>
      ...
      <section className="mx-auto max-w-3xl px-5 py-16 sm:px-8 sm:py-20">
        ...
        <div className="mt-8 space-y-6 text-slate-700">
          <p>
            Under <strong>Wyo. Stat. &sect; 1-21-1208</strong>, your landlord must return your deposit within <strong>30 days</strong> of the end of your tenancy, or within <strong>15 days</strong> after you provide a forwarding address if that is later. If the landlord claims property damage, an additional 30 days may apply with a written itemized list.
          </p>
          <p>
            Wyoming does not use a 2&times; or 3&times; multiplier. A landlord who wrongfully withholds your deposit is liable for:
          </p>
        ...
        <div className="mx-auto max-w-4xl px-5 py-16 sm:px-8 sm:py-20">
          ...
          <div className="mt-8 grid gap-6 sm:grid-cols-2">
            ...
            <div>
              ...
              <p className="mt-2 text-sm text-slate-600">Wyo. Stat. &sect; 1-21-1208 and any others triggered by your circumstances &mdash; not generic legalese.</p>
            </div>
            <div>
              <h3 className="font-medium text-slate-900">The right legal theory</h3>
              <p className="mt-2 text-sm text-slate-600">The letter presses Wyoming&apos;s requirement that a wrongful landlord return the full deposit plus your court costs.</p>
            </div>
            <div>
