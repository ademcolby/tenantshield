// app/states/west-virginia/page.tsx
import type { Metadata } from 'next';
import Link from 'next/link';

const STATE = 'West Virginia';
const DEADLINE = '60 days';
const STATUTE = 'W. Va. Code § 37-6A-1';
const PENALTY = '1.5× the wrongfully withheld amount';
    ...
    <div className="min-h-screen bg-[#FAFAF7]" style={{ fontFamily: 'var(--font-sans)' }}>
      ...
      <section className="mx-auto max-w-4xl px-5 py-16 sm:px-8 sm:py-24">
        ...
        <p className="mt-6 max-w-2xl text-lg text-slate-700">
          A professional demand letter citing West Virginia's security deposit statute (W. Va. Code &sect; 37-6A), the return deadline, and the one-and-a-half-times penalty for deliberate withholding. Ready in minutes.
        </p>
      ...
      <section className="mx-auto max-w-4xl px-5 pb-16 sm:px-8">
        <div className="grid gap-4 sm:grid-cols-3">
          <div className="rounded-xl border border-[#E7E5E0] bg-white p-6">
            ...
            <p className="mt-1 text-sm text-slate-600">or 45 days if a new tenant moves in first</p>
          </div>
          <div className="rounded-xl border border-[#E7E5E0] bg-white p-6">
            <p className="text-xs font-semibold uppercase tracking-widest text-slate-500">Penalty</p>
            <p className="mt-2 text-2xl font-medium text-slate-900" style={{ fontFamily: 'var(--font-display)' }}>1.5&times; damages</p>
            <p className="mt-1 text-sm text-slate-600">for deliberate withholding</p>
          </div>
          <div className="rounded-xl border border-[#E7E5E0] bg-white p-6">
            <p className="text-xs font-semibold uppercase tracking-widest text-slate-500">Statute</p>
            <p className="mt-2 text-2xl font-medium text-slate-900" style={{ fontFamily: 'var(--font-display)' }}>§ 37-6A</p>
            <p className="mt-1 text-sm text-slate-600">West Virginia Code</p>
          </div>
        </div>
      </section>
      ...
      <section className="mx-auto max-w-3xl px-5 py-16 sm:px-8 sm:py-20">
        ...
        <div className="mt-8 space-y-6 text-slate-700">
          <p>
            Under <strong>W. Va. Code &sect; 37-6A</strong>, your landlord has <strong>60 days</strong> after your tenancy ends (or 45 days if a new tenant moves in sooner) to return your security deposit or provide a written, itemized statement of any deductions.
          </p>
          <p>
            If the landlord <strong>deliberately</strong> fails to comply, you may recover:
          </p>
          <ul className="ml-6 list-disc space-y-2">
            <li>Damages equal to <strong>one and one-half times</strong> the amount wrongfully withheld</li>
          </ul>
          <p>
            So a $1,500 deposit wrongfully withheld can support a court judgment of <strong>$2,250</strong>. Most landlords settle quickly once they realize you know the law.
          </p>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-4xl px-5 py-16 sm:px-8 sm:py-20">
          ...
          <div className="mt-8 grid gap-6 sm:grid-cols-2">
            ...
            <div>
              ...
              <p className="mt-2 text-sm text-slate-600">W. Va. Code &sect; 37-6A and any others triggered by your circumstances &mdash; not generic legalese.</p>
            </div>
            <div>
              <h3 className="font-medium text-slate-900">Calculated penalty math</h3>
              <p className="mt-2 text-sm text-slate-600">The letter states the exact dollar amount you&apos;re entitled to demand &mdash; 1.5&times; the amount wrongfully withheld.</p>
            </div>
            <div>
