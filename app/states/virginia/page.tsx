// app/states/virginia/page.tsx
import type { Metadata } from 'next';
import Link from 'next/link';

const STATE = 'Virginia';
const DEADLINE = '45 days';
const STATUTE = 'Va. Code § 55.1-1226';
const PENALTY = 'forfeiture of the right to withhold + actual damages + attorney fees';
    ...
    <div className="min-h-screen bg-[#FAFAF7]" style={{ fontFamily: 'var(--font-sans)' }}>
      ...
      <section className="mx-auto max-w-4xl px-5 py-16 sm:px-8 sm:py-24">
        ...
        <p className="mt-6 max-w-2xl text-lg text-slate-700">
          A professional demand letter citing {STATE}&apos;s Residential Landlord and Tenant Act (Va. Code &sect; 55.1-1226), the 45-day return deadline, and the remedies available when a landlord wrongfully withholds. Ready in minutes.
        </p>
      ...
      <section className="mx-auto max-w-4xl px-5 pb-16 sm:px-8">
        <div className="grid gap-4 sm:grid-cols-3">
          ...
          <div className="rounded-xl border border-[#E7E5E0] bg-white p-6">
            ...
            <p className="mt-1 text-sm text-slate-600">plus actual damages and attorney fees</p>
          </div>
          <div className="rounded-xl border border-[#E7E5E0] bg-white p-6">
            <p className="text-xs font-semibold uppercase tracking-widest text-slate-500">Statute</p>
            <p className="mt-2 text-2xl font-medium text-slate-900" style={{ fontFamily: 'var(--font-display)' }}>&sect; 55.1-1226</p>
            <p className="mt-1 text-sm text-slate-600">Code of {STATE}</p>
          </div>
        </div>
      </section>
      ...
      <section className="mx-auto max-w-3xl px-5 py-16 sm:px-8 sm:py-20">
        ...
        <div className="mt-8 space-y-6 text-slate-700">
          <p>
            Under <strong>{STATUTE}</strong>, your landlord has <strong>45 days</strong> after your tenancy ends to return your security deposit along with a written, itemized statement of any deductions. (If a third-party contractor is needed to assess damage, the landlord gets an additional 15 days, but must notify you in writing.)
          </p>
          <p>
            {STATE} does not apply a flat 2&times; or 3&times; multiplier. Instead, a landlord who fails to meet the deadline <strong>forfeits the right to withhold any part of your deposit</strong>, and where the withholding is willful you may recover:
          </p>
          <ul className="ml-6 list-disc space-y-2">
            <li>The <strong>full deposit</strong> back, plus any actual damages you suffered</li>
            <li><strong>Reasonable attorney&apos;s fees</strong> and court costs</li>
          </ul>
          <p>
            So if your landlord misses the 45-day deadline or skips the required accounting, the deductions they tried to claim collapse and you are owed the <strong>entire deposit</strong>. Most landlords return it quickly once they realize their right to withhold is gone.
          </p>
          <p className="rounded-lg border border-[#E7E5E0] bg-white p-5 text-sm text-slate-600">
            <strong className="text-slate-900">Good to know:</strong> {STATE} caps security deposits at <strong>two months&apos; rent</strong>.
          </p>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-4xl px-5 py-16 sm:px-8 sm:py-20">
          ...
          <div className="mt-8 grid gap-6 sm:grid-cols-2">
            ...
            <div>
              ...
              <p className="mt-2 text-sm text-slate-600">Va. Code &sect; 55.1-1226 and any others triggered by your circumstances &mdash; not generic legalese.</p>
            </div>
            <div>
              <h3 className="font-medium text-slate-900">The right legal theory</h3>
              <p className="mt-2 text-sm text-slate-600">The letter presses {STATE}&apos;s forfeiture remedy &mdash; that a landlord who misses the deadline loses the right to keep any of your deposit &mdash; plus your attorney fees.</p>
            </div>
            <div>
