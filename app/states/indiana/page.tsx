// app/states/indiana/page.tsx
import type { Metadata } from 'next';
import Link from 'next/link';

const STATE = 'Indiana';
const DEADLINE = '45 days';
const STATUTE = 'Ind. Code § 32-31-3-12';
const PENALTY = 'forfeiture of the right to withhold + attorney fees';

export const metadata: Metadata = {
  title: 'Security Deposit Demand Letter Indiana | TenantShield',
    ...
    <div className="min-h-screen bg-[#FAFAF7]" style={{ fontFamily: 'var(--font-sans)' }}>
      ...
      <section className="mx-auto max-w-4xl px-5 py-16 sm:px-8 sm:py-24">
        ...
        <p className="mt-6 max-w-2xl text-lg text-slate-700">
          A professional demand letter citing Indiana's security deposit statute (Ind. Code &sect; 32-31-3-12), the 45-day return deadline, and the forfeiture remedy plus attorney fees. Ready in minutes.
        </p>
      ...
      <section className="mx-auto max-w-4xl px-5 pb-16 sm:px-8">
        <div className="grid gap-4 sm:grid-cols-3">
          ...
          <div className="rounded-xl border border-[#E7E5E0] bg-white p-6">
            ...
            <p className="mt-1 text-sm text-slate-600">plus your attorney fees</p>
          </div>
          <div className="rounded-xl border border-[#E7E5E0] bg-white p-6">
            <p className="text-xs font-semibold uppercase tracking-widest text-slate-500">Statute</p>
            <p className="mt-2 text-2xl font-medium text-slate-900" style={{ fontFamily: 'var(--font-display)' }}>§ 32-31-3-12</p>
            <p className="mt-1 text-sm text-slate-600">Indiana Code</p>
          </div>
        </div>
      </section>
      ...
      <section className="mx-auto max-w-3xl px-5 py-16 sm:px-8 sm:py-20">
        ...
        <div className="mt-8 space-y-6 text-slate-700">
          <p>
            Under <strong>Ind. Code &sect; 32-31-3-12</strong>, your landlord has <strong>45 days</strong> after your tenancy ends to return your security deposit or provide a written, itemized list of any deductions.
          </p>
          <p>
            Indiana does not use a 2&times; or 3&times; multiplier. A landlord who fails to provide the itemized list within 45 days <strong>forfeits the right to keep any part of your deposit</strong>, and you may recover:
          </p>
        ...
        <div className="mx-auto max-w-4xl px-5 py-16 sm:px-8 sm:py-20">
          ...
          <div className="mt-8 grid gap-6 sm:grid-cols-2">
            ...
            <div>
              ...
              <p className="mt-2 text-sm text-slate-600">Ind. Code &sect; 32-31-3-12 and any others triggered by your circumstances &mdash; not generic legalese.</p>
            </div>
            <div>
              <h3 className="font-medium text-slate-900">The right legal theory</h3>
              <p className="mt-2 text-sm text-slate-600">The letter presses Indiana&apos;s forfeiture remedy &mdash; that a landlord who misses the deadline loses the right to keep any of your deposit &mdash; plus your attorney fees.</p>
            </div>
            <div>
