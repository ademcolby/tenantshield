// app/states/oregon/page.tsx
import type { Metadata } from 'next';
import Link from 'next/link';

const STATE = 'Oregon';
const DEADLINE = '31 days';
const STATUTE = 'ORS § 90.300';
const PENALTY = '2× the wrongfully withheld amount';

export const metadata: Metadata = {
  title: 'Security Deposit Demand Letter Oregon | TenantShield',
    ...
    <div className="min-h-screen bg-[#FAFAF7]" style={{ fontFamily: 'var(--font-sans)' }}>
      ...
      <section className="mx-auto max-w-4xl px-5 py-16 sm:px-8 sm:py-24">
        ...
        <p className="mt-6 max-w-2xl text-lg text-slate-700">
          A professional demand letter citing Oregon's Residential Landlord and Tenant Act (ORS &sect; 90.300), the 31-day return deadline, and the double-damages penalty for wrongful withholding. Ready in minutes.
        </p>
      ...
      <section className="mx-auto max-w-4xl px-5 pb-16 sm:px-8">
        <div className="grid gap-4 sm:grid-cols-3">
          ...
          <div className="rounded-xl border border-[#E7E5E0] bg-white p-6">
            ...
            <p className="mt-1 text-sm text-slate-600">for wrongful withholding under &sect; 90.300</p>
          </div>
          <div className="rounded-xl border border-[#E7E5E0] bg-white p-6">
            <p className="text-xs font-semibold uppercase tracking-widest text-slate-500">Statute</p>
            <p className="mt-2 text-2xl font-medium text-slate-900" style={{ fontFamily: 'var(--font-display)' }}>§ 90.300</p>
            <p className="mt-1 text-sm text-slate-600">Oregon Revised Statutes</p>
          </div>
        </div>
      </section>
      ...
      <section className="mx-auto max-w-3xl px-5 py-16 sm:px-8 sm:py-20">
        ...
        <div className="mt-8 space-y-6 text-slate-700">
          <p>
            Under <strong>ORS &sect; 90.300</strong>, your landlord has <strong>31 days</strong> after your tenancy ends and you deliver possession to return your security deposit or provide a written, itemized accounting of any deductions.
          </p>
          <p>
          ...
          <p className="rounded-lg border border-[#E7E5E0] bg-white p-5 text-sm text-slate-600">
            <strong className="text-slate-900">Living in Portland?</strong> The city adds its own deposit protections (PCC 30.01.087) on top of the state rule &mdash; your letter applies both layers when they fit your situation.
          </p>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-4xl px-5 py-16 sm:px-8 sm:py-20">
          ...
          <div className="mt-8 grid gap-6 sm:grid-cols-2">
            ...
            <div>
              ...
              <p className="mt-2 text-sm text-slate-600">ORS &sect; 90.300 and any others triggered by your circumstances &mdash; not generic legalese.</p>
            </div>
            <div>
