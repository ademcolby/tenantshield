// app/states/michigan/page.tsx
import type { Metadata } from 'next';
import Link from 'next/link';

const STATE = 'Michigan';
const DEADLINE = '30 days';
const STATUTE = 'MCL § 554.609 & § 554.613';
const PENALTY = '2× wrongfully withheld amount + attorney fees';
    ...
    <div className="min-h-screen bg-[#FAFAF7]" style={{ fontFamily: 'var(--font-sans)' }}>
      ...
      <section className="mx-auto max-w-4xl px-5 py-16 sm:px-8 sm:py-24">
        ...
        <p className="mt-6 max-w-2xl text-lg text-slate-700">
          A professional demand letter citing {STATE}&apos;s security deposit statutes (MCL &sect; 554.609 and &sect; 554.613), the 30-day return deadline, and the double-damages penalty for wrongful withholding. Ready in minutes.
        </p>
      ...
      <section className="mx-auto max-w-4xl px-5 pb-16 sm:px-8">
        <div className="grid gap-4 sm:grid-cols-3">
          <div className="rounded-xl border border-[#E7E5E0] bg-white p-6">
            ...
            <p className="mt-1 text-sm text-slate-600">to send an itemized list after move-out</p>
          </div>
          <div className="rounded-xl border border-[#E7E5E0] bg-white p-6">
            ...
            <p className="mt-1 text-sm text-slate-600">for wrongful withholding under &sect; 554.613</p>
          </div>
          <div className="rounded-xl border border-[#E7E5E0] bg-white p-6">
            <p className="text-xs font-semibold uppercase tracking-widest text-slate-500">Statute</p>
            <p className="mt-2 text-2xl font-medium text-slate-900" style={{ fontFamily: 'var(--font-display)' }}>&sect; 554.609</p>
            <p className="mt-1 text-sm text-slate-600">{STATE} Compiled Laws</p>
          </div>
        </div>
      </section>
      ...
      <section className="mx-auto max-w-3xl px-5 py-16 sm:px-8 sm:py-20">
        ...
        <div className="mt-8 space-y-6 text-slate-700">
          <p>
            Under <strong>MCL &sect; 554.609</strong>, your landlord has <strong>30 days</strong> after your tenancy ends to mail you an itemized list of any deductions and return the balance of your security deposit. This requires a written forwarding address from you.
          </p>
          <p>
            If the landlord keeps your deposit improperly &mdash; and fails to file suit within 45 days to justify the deductions &mdash; <strong>MCL &sect; 554.613</strong> allows you to recover:
          </p>
          ...
          <p className="rounded-lg border border-[#E7E5E0] bg-white p-5 text-sm text-slate-600">
            <strong className="text-slate-900">Important:</strong> {STATE} requires you to give your landlord a <strong>written forwarding address within 4 days</strong> of moving out to preserve your rights. Your demand letter supplies your address in writing.
          </p>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-4xl px-5 py-16 sm:px-8 sm:py-20">
          ...
          <div className="mt-8 grid gap-6 sm:grid-cols-2">
            ...
            <div>
              ...
              <p className="mt-2 text-sm text-slate-600">MCL &sect; 554.609, &sect; 554.613, and any others triggered by your circumstances &mdash; not generic legalese.</p>
            </div>
            <div>
              <h3 className="font-medium text-slate-900">Calculated penalty math</h3>
              <p className="mt-2 text-sm text-slate-600">The letter states the exact dollar amount you&apos;re entitled to demand &mdash; deposit + 2&times; wrongful withholding + fees &mdash; and supplies your forwarding address in writing.</p>
            </div>
            <div>
