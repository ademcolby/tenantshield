// app/states/new-mexico/page.tsx
import type { Metadata } from 'next';
import Link from 'next/link';

const STATE = 'New Mexico';
const DEADLINE = '30 days';
const STATUTE = 'NMSA § 47-8-18';
const PENALTY = 'forfeiture + $250 civil penalty + attorney fees';
    ...
    <div className="min-h-screen bg-[#FAFAF7]" style={{ fontFamily: 'var(--font-sans)' }}>
      ...
      <section className="mx-auto max-w-4xl px-5 py-16 sm:px-8 sm:py-24">
        ...
        <p className="mt-6 max-w-2xl text-lg text-slate-700">
          A professional demand letter citing New Mexico's deposit statute (NMSA &sect; 47-8-18), the 30-day return deadline, and the forfeiture-plus-penalty remedy. Ready in minutes.
        </p>
      ...
      <section className="mx-auto max-w-4xl px-5 pb-16 sm:px-8">
        <div className="grid gap-4 sm:grid-cols-3">
          ...
          <div className="rounded-xl border border-[#E7E5E0] bg-white p-6">
            ...
            <p className="mt-2 text-2xl font-medium text-slate-900" style={{ fontFamily: 'var(--font-display)' }}>$250 + forfeiture</p>
            <p className="mt-1 text-sm text-slate-600">for failing to refund within 30 days</p>
          </div>
          <div className="rounded-xl border border-[#E7E5E0] bg-white p-6">
            <p className="text-xs font-semibold uppercase tracking-widest text-slate-500">Statute</p>
            <p className="mt-2 text-2xl font-medium text-slate-900" style={{ fontFamily: 'var(--font-display)' }}>§ 47-8-18</p>
            <p className="mt-1 text-sm text-slate-600">New Mexico Statutes</p>
          </div>
        </div>
      </section>
      ...
      <section className="mx-auto max-w-3xl px-5 py-16 sm:px-8 sm:py-20">
        ...
        <div className="mt-8 space-y-6 text-slate-700">
          <p>
            Under <strong>NMSA &sect; 47-8-18</strong>, your landlord has <strong>30 days</strong> after your tenancy ends to return your security deposit or provide a written, itemized statement of any deductions.
          </p>
          <p>
            New Mexico does not use a 2&times; or 3&times; multiplier. A landlord who fails to provide the itemized refund within 30 days:
          </p>
          <ul className="ml-6 list-disc space-y-2">
            <li><strong>Forfeits the right to withhold</strong> any part of the deposit</li>
            <li>Owes a <strong>$250 civil penalty</strong></li>
            <li>Owes your <strong>reasonable attorney&apos;s fees</strong> and costs</li>
          </ul>
          <p>
        ...
        <div className="mx-auto max-w-4xl px-5 py-16 sm:px-8 sm:py-20">
          ...
          <div className="mt-8 grid gap-6 sm:grid-cols-2">
            ...
            <div>
              ...
              <p className="mt-2 text-sm text-slate-600">NMSA &sect; 47-8-18 and any others triggered by your circumstances &mdash; not generic legalese.</p>
            </div>
            <div>
              <h3 className="font-medium text-slate-900">Calculated penalty math</h3>
              <p className="mt-2 text-sm text-slate-600">The letter states the exact dollar amount you&apos;re entitled to demand &mdash; full deposit + the $250 civil penalty + your attorney fees.</p>
            </div>
            <div>
