    ...
    <div className="min-h-screen bg-[#FAFAF7]" style={{ fontFamily: 'var(--font-sans)' }}>
      ...
      <section className="mx-auto max-w-4xl px-5 py-16 sm:px-8 sm:py-24">
        ...
        <p className="mt-6 max-w-2xl text-lg text-slate-700">
          A professional demand letter citing {STATE}&apos;s Landlords and Tenants Act (ORC &sect; 5321.16), the 30-day return deadline, and the double-damages penalty for wrongful withholding. Ready in minutes.
        </p>
      ...
      <section className="mx-auto max-w-4xl px-5 pb-16 sm:px-8">
        <div className="grid gap-4 sm:grid-cols-3">
          ...
          <div className="rounded-xl border border-[#E7E5E0] bg-white p-6">
            ...
            <p className="mt-2 text-2xl font-medium text-slate-900" style={{ fontFamily: 'var(--font-display)' }}>&sect; 5321.16</p>
            <p className="mt-1 text-sm text-slate-600">{STATE} Revised Code</p>
          </div>
        </div>
      </section>
      ...
      <section className="mx-auto max-w-3xl px-5 py-16 sm:px-8 sm:py-20">
        ...
        <div className="mt-8 space-y-6 text-slate-700">
          <p>
            Under <strong>{STATUTE}</strong>, your landlord has <strong>30 days</strong> after your tenancy ends and you hand back possession to return your security deposit or provide a written, itemized list of deductions.
          </p>
          <p>
            If the landlord wrongfully withholds any part of your deposit, you may recover:
          </p>
          <ul className="ml-6 list-disc space-y-2">
            <li>The amount wrongfully withheld, plus <strong>damages equal to that amount</strong> (effectively two times)</li>
          ...
          <p className="rounded-lg border border-[#E7E5E0] bg-white p-5 text-sm text-slate-600">
            <strong className="text-slate-900">Important:</strong> In {STATE}, you must give your landlord a <strong>written forwarding address</strong> to preserve your right to the damages and attorney fees. Your demand letter includes your address in writing, which protects that right.
          </p>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-4xl px-5 py-16 sm:px-8 sm:py-20">
          ...
          <div className="mt-8 grid gap-6 sm:grid-cols-2">
            ...
            <div>
              ...
              <p className="mt-2 text-sm text-slate-600">ORC &sect; 5321.16 and any others triggered by your circumstances &mdash; not generic legalese.</p>
            </div>
            <div>
