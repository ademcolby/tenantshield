// app/states/wisconsin/page.tsx
import type { Metadata } from 'next';
import Link from 'next/link';

const STATE = 'Wisconsin';
const DEADLINE = '21 days';
const STATUTE = 'Wis. Admin. Code ATCP 134.06';
const PENALTY = '2× wrongfully withheld amount + attorney fees';

export const metadata: Metadata = {
  title: 'Security Deposit Demand Letter Wisconsin | TenantShield',
    ...
    <div className="min-h-screen bg-[#FAFAF7]" style={{ fontFamily: 'var(--font-sans)' }}>
      ...
      <section className="mx-auto max-w-4xl px-5 pb-16 sm:px-8">
        <div className="grid gap-4 sm:grid-cols-3">
          ...
          <div className="rounded-xl border border-[#E7E5E0] bg-white p-6">
            ...
            <p className="mt-1 text-sm text-slate-600">for wrongful withholding plus attorney fees</p>
          </div>
          <div className="rounded-xl border border-[#E7E5E0] bg-white p-6">
            <p className="text-xs font-semibold uppercase tracking-widest text-slate-500">Statute</p>
            <p className="mt-2 text-2xl font-medium text-slate-900" style={{ fontFamily: 'var(--font-display)' }}>ATCP 134.06</p>
            <p className="mt-1 text-sm text-slate-600">Wisconsin Administrative Code</p>
          </div>
        </div>
      </section>
      ...
      <section className="mx-auto max-w-3xl px-5 py-16 sm:px-8 sm:py-20">
        ...
        <div className="mt-8 space-y-6 text-slate-700">
          <p>
            Under <strong>Wis. Admin. Code ATCP 134.06</strong>, your landlord has <strong>21 days</strong> after your tenancy ends to return your security deposit or provide a written, itemized statement of any deductions.
          </p>
          <p>
            If the landlord wrongfully withholds any part of your deposit, you may recover the following under Wis. Stat. &sect; 100.20(5):
          </p>
        ...
        <div className="mx-auto max-w-4xl px-5 py-16 sm:px-8 sm:py-20">
          ...
          <div className="mt-8 grid gap-6 sm:grid-cols-2">
            ...
            <div>
              ...
              <p className="mt-2 text-sm text-slate-600">Wis. Admin. Code ATCP 134.06 and Wis. Stat. &sect; 100.20(5) and any others triggered by your circumstances &mdash; not generic legalese.</p>
            </div>
            <div>
