// app/states/missouri/page.tsx
import type { Metadata } from 'next';
import Link from 'next/link';

const STATE = 'Missouri';
const DEADLINE = '30 days';
const STATUTE = 'RSMo § 535.300';
const PENALTY = 'up to 2× the amount wrongfully withheld';
    ...
    <div className="min-h-screen bg-[#FAFAF7]" style={{ fontFamily: 'var(--font-sans)' }}>
      ...
      <section className="mx-auto max-w-4xl px-5 py-16 sm:px-8 sm:py-24">
        ...
        <p className="mt-6 max-w-2xl text-lg text-slate-700">
          A professional demand letter citing {STATE}&apos;s security deposit statute (RSMo &sect; 535.300), the 30-day return deadline, and the up-to-double-damages penalty for wrongful withholding. Ready in minutes.
        </p>
      ...
      <section className="mx-auto max-w-4xl px-5 pb-16 sm:px-8">
        <div className="grid gap-4 sm:grid-cols-3">
          ...
          <div className="rounded-xl border border-[#E7E5E0] bg-white p-6">
            ...
            <p className="mt-2 text-2xl font-medium text-slate-900" style={{ fontFamily: 'var(--font-display)' }}>&sect; 535.300</p>
      ...
      <section className="mx-auto max-w-3xl px-5 py-16 sm:px-8 sm:py-20">
        ...
        <div className="mt-8 space-y-6 text-slate-700">
          <p>
            Under <strong>{STATUTE}</strong>, your landlord has <strong>30 days</strong> after your tenancy ends to return your security deposit or provide a written, itemized list of any deductions.
          </p>
          <p>
          ...
          <p>
            So a $1,500 deposit wrongfully withheld can support a court judgment of up to <strong>$3,000</strong>. {STATE} courts enforce &sect; 535.300 strictly as a consumer-protection statute &mdash; lease clauses that try to waive these rights are unenforceable &mdash; so most landlords settle quickly once they realize you know the law.
          </p>
          <p className="rounded-lg border border-[#E7E5E0] bg-white p-5 text-sm text-slate-600">
            <strong className="text-slate-900">Good to know:</strong> {STATE} caps security deposits at <strong>two months&apos; rent</strong>, and you have the right to request to be present at the move-out inspection.
          </p>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-4xl px-5 py-16 sm:px-8 sm:py-20">
          ...
          <div className="mt-8 grid gap-6 sm:grid-cols-2">
            ...
            <div>
              ...
              <p className="mt-2 text-sm text-slate-600">RSMo &sect; 535.300 and any others triggered by your circumstances &mdash; not generic legalese.</p>
            </div>
            <div>
              <h3 className="font-medium text-slate-900">Calculated penalty math</h3>
              <p className="mt-2 text-sm text-slate-600">The letter states the exact dollar amount you&apos;re entitled to demand &mdash; deposit + up to 2&times; wrongful withholding.</p>
            </div>
            <div>
