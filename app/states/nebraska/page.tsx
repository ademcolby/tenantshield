// app/states/nebraska/page.tsx
import type { Metadata } from 'next';
import Link from 'next/link';

const STATE = 'Nebraska';
const DEADLINE = '14 days';
const STATUTE = 'Neb. Rev. Stat. § 76-1416';
const PENALTY = 'lesser of one month of rent or 2× deposit + attorney fees';
    ...
    <div className="min-h-screen bg-[#FAFAF7]" style={{ fontFamily: 'var(--font-sans)' }}>
      ...
      <section className="mx-auto max-w-4xl px-5 py-16 sm:px-8 sm:py-24">
        ...
        <p className="mt-6 max-w-2xl text-lg text-slate-700">
          A professional demand letter citing Nebraska's deposit statute (Neb. Rev. Stat. &sect; 76-1416), the 14-day return deadline, and the liquidated-damages penalty for willful withholding. Ready in minutes.
        </p>
      ...
      <section className="mx-auto max-w-4xl px-5 pb-16 sm:px-8">
        <div className="grid gap-4 sm:grid-cols-3">
          <div className="rounded-xl border border-[#E7E5E0] bg-white p-6">
            ...
            <p className="mt-1 text-sm text-slate-600">after your demand and address designation</p>
          </div>
          <div className="rounded-xl border border-[#E7E5E0] bg-white p-6">
            <p className="text-xs font-semibold uppercase tracking-widest text-slate-500">Penalty</p>
            <p className="mt-2 text-2xl font-medium text-slate-900" style={{ fontFamily: 'var(--font-display)' }}>1 mo / 2&times;</p>
            <p className="mt-1 text-sm text-slate-600">lesser of, for willful bad-faith withholding</p>
          </div>
          <div className="rounded-xl border border-[#E7E5E0] bg-white p-6">
            <p className="text-xs font-semibold uppercase tracking-widest text-slate-500">Statute</p>
            <p className="mt-2 text-2xl font-medium text-slate-900" style={{ fontFamily: 'var(--font-display)' }}>§ 76-1416</p>
            <p className="mt-1 text-sm text-slate-600">Nebraska Revised Statutes</p>
          </div>
        </div>
      </section>
      ...
      <section className="mx-auto max-w-3xl px-5 py-16 sm:px-8 sm:py-20">
        ...
        <div className="mt-8 space-y-6 text-slate-700">
          <p>
            Under <strong>Neb. Rev. Stat. &sect; 76-1416</strong>, your landlord has <strong>14 days</strong> after your tenancy ends and you demand the deposit and designate where it should be sent to return it or provide a written, itemized statement.
          </p>
          <p>
            If the landlord&apos;s withholding is <strong>willful and not in good faith</strong>, you may recover:
          </p>
          <ul className="ml-6 list-disc space-y-2">
            <li>Liquidated damages equal to the <strong>lesser of one month&apos;s rent or twice the deposit</strong></li>
        ...
        <div className="mx-auto max-w-4xl px-5 py-16 sm:px-8 sm:py-20">
          ...
          <div className="mt-8 grid gap-6 sm:grid-cols-2">
            ...
            <div>
              ...
              <p className="mt-2 text-sm text-slate-600">Neb. Rev. Stat. &sect; 76-1416 and any others triggered by your circumstances &mdash; not generic legalese.</p>
            </div>
            <div>
              <h3 className="font-medium text-slate-900">Calculated penalty math</h3>
              <p className="mt-2 text-sm text-slate-600">The letter states the exact dollar amount you&apos;re entitled to demand &mdash; the lesser of one month&apos;s rent or 2&times; the deposit, plus fees.</p>
            </div>
            <div>
