// app/states/hawaii/page.tsx
import type { Metadata } from 'next';
import Link from 'next/link';

const STATE = 'Hawaii';
const DEADLINE = '14 days';
const STATUTE = 'HRS § 521-44';
const PENALTY = 'up to 3× for willful withholding';
    ...
    <div className="min-h-screen bg-[#FAFAF7]" style={{ fontFamily: 'var(--font-sans)' }}>
      ...
      <section className="mx-auto max-w-4xl px-5 py-16 sm:px-8 sm:py-24">
        ...
        <p className="mt-6 max-w-2xl text-lg text-slate-700">
          A professional demand letter citing Hawaii's Residential Landlord-Tenant Code (HRS &sect; 521-44), the 14-day return deadline, and the treble-damages penalty for willful withholding. Ready in minutes.
        </p>
      ...
      <section className="mx-auto max-w-4xl px-5 pb-16 sm:px-8">
        <div className="grid gap-4 sm:grid-cols-3">
          ...
          <div className="rounded-xl border border-[#E7E5E0] bg-white p-6">
            ...
            <p className="mt-1 text-sm text-slate-600">for willful withholding under &sect; 521-44</p>
          </div>
          <div className="rounded-xl border border-[#E7E5E0] bg-white p-6">
            <p className="text-xs font-semibold uppercase tracking-widest text-slate-500">Statute</p>
            <p className="mt-2 text-2xl font-medium text-slate-900" style={{ fontFamily: 'var(--font-display)' }}>§ 521-44</p>
            <p className="mt-1 text-sm text-slate-600">Hawaii Revised Statutes</p>
          </div>
        </div>
      </section>
      ...
      <section className="mx-auto max-w-3xl px-5 py-16 sm:px-8 sm:py-20">
        ...
        <div className="mt-8 space-y-6 text-slate-700">
          <p>
            Under <strong>HRS &sect; 521-44</strong>, your landlord has <strong>14 days</strong> after your tenancy ends to return your security deposit or provide a written, itemized statement of any deductions.
          </p>
          <p>
          ...
          <ul className="ml-6 list-disc space-y-2">
            ...
            <li>Plus, where applicable, your costs</li>
          </ul>
          <p>
        ...
        <div className="mx-auto max-w-4xl px-5 py-16 sm:px-8 sm:py-20">
          ...
          <div className="mt-8 grid gap-6 sm:grid-cols-2">
            ...
            <div>
              ...
              <p className="mt-2 text-sm text-slate-600">HRS &sect; 521-44 and any others triggered by your circumstances &mdash; not generic legalese.</p>
            </div>
            <div>
              <h3 className="font-medium text-slate-900">Calculated penalty math</h3>
              <p className="mt-2 text-sm text-slate-600">The letter states the exact dollar amount you&apos;re entitled to demand &mdash; up to 3&times; the amount wrongfully withheld where retention is willful.</p>
            </div>
            <div>
