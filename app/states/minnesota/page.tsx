// app/states/minnesota/page.tsx
import type { Metadata } from 'next';
import Link from 'next/link';

const STATE = 'Minnesota';
const DEADLINE = '21 days';
const STATUTE = 'Minn. Stat. § 504B.178';
const PENALTY = '2× wrongfully withheld amount + $500 + attorney fees';
    ...
    <div className="min-h-screen bg-[#FAFAF7]" style={{ fontFamily: 'var(--font-sans)' }}>
      ...
      <section className="mx-auto max-w-4xl px-5 py-16 sm:px-8 sm:py-24">
        ...
        <p className="mt-6 max-w-2xl text-lg text-slate-700">
          A professional demand letter citing {STATE}&apos;s security deposit statute (Minn. Stat. &sect; 504B.178), the 21-day return deadline, and the double-damages-plus-penalty award for bad-faith withholding. Ready in minutes.
        </p>
      ...
      <section className="mx-auto max-w-4xl px-5 pb-16 sm:px-8">
        <div className="grid gap-4 sm:grid-cols-3">
          ...
          <div className="rounded-xl border border-[#E7E5E0] bg-white p-6">
            ...
            <p className="mt-2 text-2xl font-medium text-slate-900" style={{ fontFamily: 'var(--font-display)' }}>2&times; + $500</p>
          ...
          <div className="rounded-xl border border-[#E7E5E0] bg-white p-6">
            ...
            <p className="mt-2 text-2xl font-medium text-slate-900" style={{ fontFamily: 'var(--font-display)' }}>&sect; 504B.178</p>
      ...
      <section className="mx-auto max-w-3xl px-5 py-16 sm:px-8 sm:py-20">
        ...
        <div className="mt-8 space-y-6 text-slate-700">
          <p>
            Under <strong>{STATUTE}</strong>, your landlord has <strong>21 days</strong> after your tenancy ends and you provide a forwarding address to return your security deposit, with interest, or provide a written statement explaining any amount kept.
          </p>
          <p>
          ...
          <ul className="ml-6 list-disc space-y-2">
            ...
            <li>An additional <strong>$500</strong> statutory penalty</li>
            <li><strong>Reasonable attorney&apos;s fees</strong></li>
          </ul>
          <p>
            So a $1,500 deposit wrongfully withheld can support a court judgment of <strong>$3,500 plus fees</strong> &mdash; $3,000 in double damages plus the $500 penalty. Most landlords settle quickly once they realize you know the law.
          </p>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-4xl px-5 py-16 sm:px-8 sm:py-20">
          ...
          <div className="mt-8 grid gap-6 sm:grid-cols-2">
            ...
            <div>
              ...
              <p className="mt-2 text-sm text-slate-600">Minn. Stat. &sect; 504B.178 and any others triggered by your circumstances &mdash; not generic legalese.</p>
            </div>
            <div>
              <h3 className="font-medium text-slate-900">Calculated penalty math</h3>
              <p className="mt-2 text-sm text-slate-600">The letter states the exact dollar amount you&apos;re entitled to demand &mdash; 2&times; wrongful withholding + the $500 penalty + fees.</p>
            </div>
            <div>
