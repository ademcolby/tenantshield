// app/states/louisiana/page.tsx
import type { Metadata } from 'next';
import Link from 'next/link';

const STATE = 'Louisiana';
const DEADLINE = '1 month';
const STATUTE = 'La. R.S. § 9:3251 & § 9:3252';
const PENALTY = 'greater of $300 or 2× wrongfully withheld + attorney fees';

export const metadata: Metadata = {
  title: 'Security Deposit Demand Letter Louisiana | TenantShield',
    ...
    <div className="min-h-screen bg-[#FAFAF7]" style={{ fontFamily: 'var(--font-sans)' }}>
      ...
      <section className="mx-auto max-w-4xl px-5 py-16 sm:px-8 sm:py-24">
        ...
        <p className="mt-6 max-w-2xl text-lg text-slate-700">
          A professional demand letter citing Louisiana's security deposit law (La. R.S. &sect; 9:3251 and &sect; 9:3252), the one-month return deadline, and the penalty for willful withholding. Ready in minutes.
        </p>
      ...
      <section className="mx-auto max-w-4xl px-5 pb-16 sm:px-8">
        <div className="grid gap-4 sm:grid-cols-3">
          <div className="rounded-xl border border-[#E7E5E0] bg-white p-6">
            ...
            <p className="mt-1 text-sm text-slate-600">to return your deposit after the lease ends</p>
          </div>
          <div className="rounded-xl border border-[#E7E5E0] bg-white p-6">
            <p className="text-xs font-semibold uppercase tracking-widest text-slate-500">Penalty</p>
            <p className="mt-2 text-2xl font-medium text-slate-900" style={{ fontFamily: 'var(--font-display)' }}>$300 or 2&times;</p>
            <p className="mt-1 text-sm text-slate-600">whichever is greater, for willful withholding</p>
          </div>
          <div className="rounded-xl border border-[#E7E5E0] bg-white p-6">
            <p className="text-xs font-semibold uppercase tracking-widest text-slate-500">Statute</p>
            <p className="mt-2 text-2xl font-medium text-slate-900" style={{ fontFamily: 'var(--font-display)' }}>§ 9:3252</p>
            <p className="mt-1 text-sm text-slate-600">Louisiana Revised Statutes</p>
          </div>
        </div>
      </section>
      ...
      <section className="mx-auto max-w-3xl px-5 py-16 sm:px-8 sm:py-20">
        ...
        <div className="mt-8 space-y-6 text-slate-700">
          <p>
            Under <strong>La. R.S. &sect; 9:3251</strong>, your landlord has <strong>one month</strong> after the lease ends to return your security deposit or provide a written, itemized statement of any deductions. A written demand from you is generally required to trigger the penalty.
          </p>
          <p>
            If the landlord <strong>willfully</strong> fails to return your deposit after written demand, La. R.S. &sect; 9:3252 allows you to recover:
          </p>
          <ul className="ml-6 list-disc space-y-2">
            <li>The <strong>greater of $300 or two times</strong> the amount wrongfully withheld</li>
        ...
        <div className="mx-auto max-w-4xl px-5 py-16 sm:px-8 sm:py-20">
          ...
          <div className="mt-8 grid gap-6 sm:grid-cols-2">
            ...
            <div>
              ...
              <p className="mt-2 text-sm text-slate-600">La. R.S. &sect; 9:3251, &sect; 9:3252 and any others triggered by your circumstances &mdash; not generic legalese.</p>
            </div>
            <div>
              <h3 className="font-medium text-slate-900">Calculated penalty math</h3>
              <p className="mt-2 text-sm text-slate-600">The letter states the exact dollar amount you&apos;re entitled to demand &mdash; the greater of $300 or 2&times; wrongful withholding + fees.</p>
            </div>
            <div>
