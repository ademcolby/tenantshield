// app/states/north-dakota/page.tsx
import type { Metadata } from 'next';
import Link from 'next/link';

const STATE = 'North Dakota';
const DEADLINE = '30 days';
const STATUTE = 'N.D.C.C. § 47-16-07.1';
const PENALTY = 'up to 3× the wrongfully withheld amount';

export const metadata: Metadata = {
  title: 'Security Deposit Demand Letter North Dakota | TenantShield',
    ...
    <div className="min-h-screen bg-[#FAFAF7]" style={{ fontFamily: 'var(--font-sans)' }}>
      ...
      <section className="mx-auto max-w-4xl px-5 py-16 sm:px-8 sm:py-24">
        ...
        <p className="mt-6 max-w-2xl text-lg text-slate-700">
          A professional demand letter citing North Dakota's security deposit statute (N.D.C.C. &sect; 47-16-07.1), the 30-day return deadline, and the treble-damages penalty. Ready in minutes.
        </p>
      ...
      <section className="mx-auto max-w-4xl px-5 pb-16 sm:px-8">
        <div className="grid gap-4 sm:grid-cols-3">
          ...
          <div className="rounded-xl border border-[#E7E5E0] bg-white p-6">
            ...
            <p className="mt-1 text-sm text-slate-600">for withholding without reasonable justification</p>
          </div>
          <div className="rounded-xl border border-[#E7E5E0] bg-white p-6">
            <p className="text-xs font-semibold uppercase tracking-widest text-slate-500">Statute</p>
            <p className="mt-2 text-2xl font-medium text-slate-900" style={{ fontFamily: 'var(--font-display)' }}>§ 47-16-07.1</p>
            <p className="mt-1 text-sm text-slate-600">North Dakota Century Code</p>
          </div>
        </div>
      </section>
      ...
      <section className="mx-auto max-w-3xl px-5 py-16 sm:px-8 sm:py-20">
        ...
        <div className="mt-8 space-y-6 text-slate-700">
          <p>
            Under <strong>N.D.C.C. &sect; 47-16-07.1</strong>, your landlord has <strong>30 days</strong> after your tenancy ends to return your security deposit or provide a written, itemized statement of any deductions.
          </p>
          <p>
            If the landlord retains your deposit <strong>without reasonable justification</strong>, you may recover:
          </p>
          <ul className="ml-6 list-disc space-y-2">
            <li><strong>Up to three times</strong> the amount wrongfully withheld</li>
          </ul>
          <p>
            So a $1,500 deposit wrongfully withheld can support a court judgment of up to <strong>$4,500</strong>. Most landlords settle quickly once they realize you know the law.
          </p>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-4xl px-5 py-16 sm:px-8 sm:py-20">
          ...
          <div className="mt-8 grid gap-6 sm:grid-cols-2">
            ...
            <div>
              ...
              <p className="mt-2 text-sm text-slate-600">N.D.C.C. &sect; 47-16-07.1 and any others triggered by your circumstances &mdash; not generic legalese.</p>
            </div>
            <div>
              <h3 className="font-medium text-slate-900">Calculated penalty math</h3>
              <p className="mt-2 text-sm text-slate-600">The letter states the exact dollar amount you&apos;re entitled to demand &mdash; deposit + up to 3&times; the wrongfully withheld amount.</p>
            </div>
            <div>
