// app/states/iowa/page.tsx
import type { Metadata } from 'next';
import Link from 'next/link';

const STATE = 'Iowa';
const DEADLINE = '30 days';
const STATUTE = 'Iowa Code § 562A.12';
const PENALTY = 'up to 2× monthly rent + actual damages + fees';

export const metadata: Metadata = {
  title: 'Security Deposit Demand Letter Iowa | TenantShield',
    ...
    <div className="min-h-screen bg-[#FAFAF7]" style={{ fontFamily: 'var(--font-sans)' }}>
      ...
      <section className="mx-auto max-w-4xl px-5 py-16 sm:px-8 sm:py-24">
        ...
        <p className="mt-6 max-w-2xl text-lg text-slate-700">
          A professional demand letter citing Iowa's deposit statute (Iowa Code &sect; 562A.12), the 30-day return deadline, and the punitive-damages penalty for bad-faith withholding. Ready in minutes.
        </p>
      ...
      <section className="mx-auto max-w-4xl px-5 pb-16 sm:px-8">
        <div className="grid gap-4 sm:grid-cols-3">
          <div className="rounded-xl border border-[#E7E5E0] bg-white p-6">
            ...
            <p className="mt-1 text-sm text-slate-600">after you provide a forwarding address</p>
          </div>
          <div className="rounded-xl border border-[#E7E5E0] bg-white p-6">
            <p className="text-xs font-semibold uppercase tracking-widest text-slate-500">Penalty</p>
            <p className="mt-2 text-2xl font-medium text-slate-900" style={{ fontFamily: 'var(--font-display)' }}>2&times; rent</p>
            <p className="mt-1 text-sm text-slate-600">punitive damages for bad-faith withholding</p>
          </div>
          <div className="rounded-xl border border-[#E7E5E0] bg-white p-6">
            <p className="text-xs font-semibold uppercase tracking-widest text-slate-500">Statute</p>
            <p className="mt-2 text-2xl font-medium text-slate-900" style={{ fontFamily: 'var(--font-display)' }}>§ 562A.12</p>
            <p className="mt-1 text-sm text-slate-600">Iowa Code</p>
          </div>
        </div>
      </section>
      ...
      <section className="mx-auto max-w-3xl px-5 py-16 sm:px-8 sm:py-20">
        ...
        <div className="mt-8 space-y-6 text-slate-700">
          <p>
            Under <strong>Iowa Code &sect; 562A.12</strong>, your landlord has <strong>30 days</strong> after your tenancy ends and you provide a mailing address to return your security deposit or provide a written, itemized statement of any deductions.
          </p>
          <p>
            If the landlord withholds your deposit in <strong>bad faith</strong>, you may recover:
          </p>
          <ul className="ml-6 list-disc space-y-2">
            <li>Punitive damages of up to <strong>twice your monthly rent</strong></li>
            <li>Your <strong>actual damages</strong></li>
        ...
        <div className="mx-auto max-w-4xl px-5 py-16 sm:px-8 sm:py-20">
          ...
          <div className="mt-8 grid gap-6 sm:grid-cols-2">
            ...
            <div>
              ...
              <p className="mt-2 text-sm text-slate-600">Iowa Code &sect; 562A.12 and any others triggered by your circumstances &mdash; not generic legalese.</p>
            </div>
            <div>
              <h3 className="font-medium text-slate-900">Calculated penalty math</h3>
              <p className="mt-2 text-sm text-slate-600">The letter states the exact dollar amount you&apos;re entitled to demand &mdash; return of your deposit + punitive damages up to 2&times; monthly rent + fees.</p>
            </div>
            <div>
