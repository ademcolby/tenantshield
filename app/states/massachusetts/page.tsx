// app/states/massachusetts/page.tsx
import type { Metadata } from 'next';
import Link from 'next/link';

const STATE = 'Massachusetts';
const DEADLINE = '30 days';
const STATUTE = 'MGL c. 186 § 15B';
const PENALTY = '3× the deposit + 5% interest + attorney fees + court costs';

export const metadata: Metadata = {
  title: 'Security Deposit Demand Letter Massachusetts | TenantShield',
    ...
    <div className="min-h-screen bg-[#FAFAF7]" style={{ fontFamily: 'var(--font-sans)' }}>
      ...
      <section className="mx-auto max-w-4xl px-5 py-16 sm:px-8 sm:py-24">
        ...
        <p className="mt-6 max-w-2xl text-lg text-slate-700">
          A professional demand letter citing {STATE}&apos;s security deposit law (MGL c. 186 &sect; 15B), the 30-day return deadline, and the triple-damages penalty for specific violations. Ready in minutes.
        </p>
      ...
      <section className="mx-auto max-w-4xl px-5 pb-16 sm:px-8">
        <div className="grid gap-4 sm:grid-cols-3">
          ...
          <div className="rounded-xl border border-[#E7E5E0] bg-white p-6">
            ...
            <p className="mt-1 text-sm text-slate-600">for specific violations under &sect; 15B(7)</p>
          </div>
          <div className="rounded-xl border border-[#E7E5E0] bg-white p-6">
            <p className="text-xs font-semibold uppercase tracking-widest text-slate-500">Statute</p>
            <p className="mt-2 text-2xl font-medium text-slate-900" style={{ fontFamily: 'var(--font-display)' }}>c. 186 &sect; 15B</p>
            <p className="mt-1 text-sm text-slate-600">General Laws of {STATE}</p>
          </div>
        </div>
      </section>
      ...
      <section className="mx-auto max-w-3xl px-5 py-16 sm:px-8 sm:py-20">
        ...
        <div className="mt-8 space-y-6 text-slate-700">
          <p>
            Under <strong>{STATUTE}</strong>, your landlord has <strong>30 days</strong> after your tenancy ends to return your security deposit. If any portion is kept for damages, the landlord must provide a sworn, itemized statement within that 30-day window.
          </p>
          <p>
            {STATE} provides <strong>triple damages</strong>, but they are <strong>not automatic</strong> &mdash; they attach to specific violations under &sect; 15B(7), including: failing to hold the deposit in a proper interest-bearing escrow account and return it on demand, failing to provide the sworn itemized statement within 30 days, or deducting for items the statute does not allow (such as normal wear and tear). When one of these triggers applies, you may recover:
          </p>
          <ul className="ml-6 list-disc space-y-2">
            <li><strong>Three times</strong> the deposit amount</li>
            <li><strong>5% interest</strong></li>
            <li><strong>Reasonable attorney&apos;s fees</strong> and court costs</li>
          </ul>
          <p>
            So a $1,500 deposit caught by a &sect; 15B(7) violation can support a court judgment of <strong>$4,500 plus interest and fees</strong>. Most landlords settle quickly once they realize you know the law.
          </p>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-4xl px-5 py-16 sm:px-8 sm:py-20">
          ...
          <div className="mt-8 grid gap-6 sm:grid-cols-2">
            ...
            <div>
              ...
              <p className="mt-2 text-sm text-slate-600">MGL c. 186 &sect; 15B, including the precise &sect; 15B(7) clause triggered by your circumstances &mdash; not generic legalese.</p>
            </div>
            <div>
              <h3 className="font-medium text-slate-900">Calculated penalty math</h3>
              <p className="mt-2 text-sm text-slate-600">The letter states the exact dollar amount you&apos;re entitled to demand &mdash; 3&times; the deposit + 5% interest + fees &mdash; where a triple-damages trigger applies.</p>
            </div>
            <div>
