// app/states/alabama/page.tsx
import type { Metadata } from 'next';
import Link from 'next/link';

const STATE = 'Alabama';
const DEADLINE = '60 days';
const STATUTE = 'Ala. Code § 35-9A-201';
const PENALTY = '2× the deposit';

export const metadata: Metadata = {
  title: 'Security Deposit Demand Letter Alabama | TenantShield',
    ...
    <div className="min-h-screen bg-[#FAFAF7]" style={{ fontFamily: 'var(--font-sans)' }}>
      ...
      <section className="mx-auto max-w-4xl px-5 py-16 sm:px-8 sm:py-24">
        ...
        <p className="mt-6 max-w-2xl text-lg text-slate-700">
          A professional demand letter citing Alabama's deposit statute (Ala. Code &sect; 35-9A-201), the 60-day return deadline, and the double-deposit penalty for noncompliance. Ready in minutes.
        </p>
      ...
      <section className="mx-auto max-w-4xl px-5 pb-16 sm:px-8">
        <div className="grid gap-4 sm:grid-cols-3">
          ...
          <div className="rounded-xl border border-[#E7E5E0] bg-white p-6">
            ...
            <p className="mt-2 text-2xl font-medium text-slate-900" style={{ fontFamily: 'var(--font-display)' }}>2&times; deposit</p>
            <p className="mt-1 text-sm text-slate-600">for missing the 60-day deadline</p>
          </div>
          <div className="rounded-xl border border-[#E7E5E0] bg-white p-6">
            <p className="text-xs font-semibold uppercase tracking-widest text-slate-500">Statute</p>
            <p className="mt-2 text-2xl font-medium text-slate-900" style={{ fontFamily: 'var(--font-display)' }}>§ 35-9A-201</p>
            <p className="mt-1 text-sm text-slate-600">Code of Alabama</p>
          </div>
        </div>
      </section>
      ...
      <section className="mx-auto max-w-3xl px-5 py-16 sm:px-8 sm:py-20">
        ...
        <div className="mt-8 space-y-6 text-slate-700">
          <p>
            Under <strong>Ala. Code &sect; 35-9A-201</strong>, your landlord has <strong>60 days</strong> after your tenancy ends to return your security deposit or provide a written, itemized list of deductions. (Many outdated sources still cite an old 35-day figure &mdash; a 2014 amendment changed it to 60.)
          </p>
          <p>
            If the landlord fails to comply within the 60-day window, you may recover:
          </p>
          <ul className="ml-6 list-disc space-y-2">
            <li><strong>Double</strong> the amount of the deposit wrongfully withheld</li>
            <li>Any actual damages, plus court costs</li>
          </ul>
          <p>
        ...
        <div className="mx-auto max-w-4xl px-5 py-16 sm:px-8 sm:py-20">
          ...
          <div className="mt-8 grid gap-6 sm:grid-cols-2">
            ...
            <div>
              ...
              <p className="mt-2 text-sm text-slate-600">Ala. Code &sect; 35-9A-201 and any others triggered by your circumstances &mdash; not generic legalese.</p>
            </div>
            <div>
